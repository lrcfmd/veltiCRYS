...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "relax.potentials.coulomb.gradient",
        "sources": [
            "relax/potentials/coulomb/gradient.pyx"
        ]
    },
    "module_name": "relax.potentials.coulomb.gradient"
}
END: Cython Metadata */
...
#define __PYX_HAVE__relax__potentials__coulomb__gradient
#define __PYX_HAVE_API__relax__potentials__coulomb__gradient
/* Early includes */
#include <string.h>
#include <stdio.h>
...
struct __pyx_opt_args_5relax_10potentials_7coulomb_8gradient_fill_stresses;

/* "relax/potentials/coulomb/gradient.pxd":22
 * 
...
/* Module declarations from 'relax.potentials.coulomb.gradient' */
...
static double __pyx_f_5relax_10potentials_7coulomb_8gradient_erfc_drv(double, int, double); /*proto*/
...
#define __Pyx_MODULE_NAME "relax.potentials.coulomb.gradient"
extern int __pyx_module_is_main_relax__potentials__coulomb__gradient;
int __pyx_module_is_main_relax__potentials__coulomb__gradient = 0;

/* Implementation of 'relax.potentials.coulomb.gradient' */
...
/* "relax/potentials/coulomb/gradient.pyx":40
...
static __Pyx_memviewslice __pyx_f_5relax_10potentials_7coulomb_8gradient_self_drv(__Pyx_memviewslice __pyx_v_stresses, __Pyx_memviewslice __pyx_v_charges, double __pyx_v_alpha_drv, CYTHON_UNUSED double __pyx_v_volume, int __pyx_v_N) {
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("self_drv", 0);

  /* "relax/potentials/coulomb/gradient.pyx":58
 * 	"""
 ...
 */
  ...
  /* "relax/potentials/coulomb/gradient.pyx":60
 * 	cdef double k_e = 14.399645351950543
 * 
 * 	for i in range(N):             # <<<<<<<<<<<<<<
 * 		for l in range(3):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "relax/potentials/coulomb/gradient.pyx":61
 * 
 * 	for i in range(N):
 * 		for l in range(3):             # <<<<<<<<<<<<<<
 * 				stresses[l][l] -= charges[i]*charges[i] * \
 ...
 */
    for (__pyx_t_4 = 0; __pyx_t_4 < 3; __pyx_t_4+=1) {
      ...
      /* "relax/potentials/coulomb/gradient.pyx":62
 * 	for i in range(N):
 * 		for l in range(3):
 * 				stresses[l][l] -= charges[i]*charges[i] * \             # <<<<<<<<<<<<<<
 * 					alpha_drv/sqrt(pi) * k_e
 ...
 */
      ...
      /* "relax/potentials/coulomb/gradient.pyx":63
 * 		for l in range(3):
 * 				stresses[l][l] -= charges[i]*charges[i] * \
 * 					alpha_drv/sqrt(pi) * k_e             # <<<<<<<<<<<<<<
 * 	return stresses
 * 
 */
      __pyx_t_7 = (((*((int *) ( /* dim=0 */ (__pyx_v_charges.data + __pyx_t_5 * __pyx_v_charges.strides[0]) ))) * (*((int *) ( /* dim=0 */ (__pyx_v_charges.data + __pyx_t_6 * __pyx_v_charges.strides[0]) )))) * __pyx_v_alpha_drv);
      __pyx_t_8 = sqrt(M_PI);
 ...
 */
      __pyx_t_6 = __pyx_v_l;
      __pyx_t_5 = __pyx_v_l;
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_stresses.data + __pyx_t_6 * __pyx_v_stresses.strides[0]) ) + __pyx_t_5 * __pyx_v_stresses.strides[1]) )) -= ((__pyx_t_7 / __pyx_t_8) * __pyx_v_k_e);
    }
  }

  /* "relax/potentials/coulomb/gradient.pyx":64
 * 				stresses[l][l] -= charges[i]*charges[i] * \
 * 					alpha_drv/sqrt(pi) * k_e
 * 	return stresses             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __PYX_INC_MEMVIEW(&__pyx_v_stresses, 0);
  __pyx_r = __pyx_v_stresses;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("relax.potentials.coulomb.gradient.self_drv", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
...
/* "relax/potentials/coulomb/gradient.pyx":69
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
...
static double __pyx_f_5relax_10potentials_7coulomb_8gradient_erfc_drv(double __pyx_v_alpha, int __pyx_v_charges, double __pyx_v_dist) {
  double __pyx_v_drv;
  double __pyx_v_a2pi;
  double __pyx_v_term;
  double __pyx_r;
  ...
  /* "relax/potentials/coulomb/gradient.pyx":75
 * 	"""
 ...
 */
  ...
  __pyx_v_a2pi = (__pyx_t_1 / __pyx_t_2);

  /* "relax/potentials/coulomb/gradient.pyx":76
 * 	cdef double drv, a2pi, term
 * 	a2pi = 2*alpha/sqrt(pi)
 * 	term = exp(-alpha*alpha*dist*dist)             # <<<<<<<<<<<<<<
 * 
 * 	drv = - charges * \
 */
  __pyx_v_term = exp(((((-__pyx_v_alpha) * __pyx_v_alpha) * __pyx_v_dist) * __pyx_v_dist));

  /* "relax/potentials/coulomb/gradient.pyx":80
 * 	drv = - charges * \
 * 		(
 * 			a2pi*term / dist + \             # <<<<<<<<<<<<<<
 ...
 * 		)
 */
  __pyx_t_2 = (__pyx_v_a2pi * __pyx_v_term);
  ...
  /* "relax/potentials/coulomb/gradient.pyx":81
 * 		(
 * 			a2pi*term / dist + \
 * 			erfc(alpha*dist) / pow(dist, 2)             # <<<<<<<<<<<<<<
 * 		)
 * 	return drv
 */
  __pyx_t_1 = erfc((__pyx_v_alpha * __pyx_v_dist));
  __pyx_t_3 = pow(__pyx_v_dist, 2.0);
  ...
  /* "relax/potentials/coulomb/gradient.pyx":78
 * 	term = exp(-alpha*alpha*dist*dist)
 * 
 * 	drv = - charges * \             # <<<<<<<<<<<<<<
 * 		(
 * 			a2pi*term / dist + \
 */
  __pyx_v_drv = ((-__pyx_v_charges) * ((__pyx_t_2 / __pyx_v_dist) + (__pyx_t_1 / __pyx_t_3)));

  /* "relax/potentials/coulomb/gradient.pyx":83
 * 			erfc(alpha*dist) / pow(dist, 2)
 * 		)
 * 	return drv             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("relax.potentials.coulomb.gradient.erfc_drv", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}

/* "relax/potentials/coulomb/gradient.pyx":88
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
...
static __Pyx_memviewslice __pyx_f_5relax_10potentials_7coulomb_8gradient_real_drv(__Pyx_memviewslice __pyx_v_grad, __Pyx_memviewslice __pyx_v_stresses, __Pyx_memviewslice __pyx_v_pos, __Pyx_memviewslice __pyx_v_vects, __Pyx_memviewslice __pyx_v_charges, double __pyx_v_real_cut_off, double __pyx_v_alpha, double __pyx_v_alpha_drv, CYTHON_UNUSED double __pyx_v_volume, int __pyx_v_N) {
  double __pyx_v_dist;
  double __pyx_v_drv;
  double __pyx_v_term;
  double __pyx_v_k_e;
  ...
  __Pyx_memviewslice __pyx_v_part_drv = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_charges_val;
  __Pyx_memviewslice __pyx_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  int __pyx_t_2;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("real_drv", 0);

  /* "relax/potentials/coulomb/gradient.pyx":111
 * 
 * 	"""
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "relax/potentials/coulomb/gradient.pyx":112
 * 	"""
 * 	if pos.shape[1]!=3 or vects.shape[1]!=3:
 * 		raise IndexError("Points are not 3-dimensional.")             # <<<<<<<<<<<<<<
 * 
 * 	cdef double dist
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_IndexError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 112, __pyx_L1_error)
 ...
 */
  ...
  /* "relax/potentials/coulomb/gradient.pyx":121
 * 	cdef double[:,:] shifts
 ...
 */
  __pyx_v_charges_val = 0;

  /* "relax/potentials/coulomb/gradient.pyx":123
 * 	cdef int charges_val = 0
 * 
 * 	shifts = get_shifts(vects, real_cut_off)             # <<<<<<<<<<<<<<
 * 	if shifts == None:
 * 		shifts_no = 0
 */
  __pyx_t_4 = __pyx_f_5relax_10potentials_6cutoff_inflated_cell_truncation(__pyx_v_vects, __pyx_v_real_cut_off, 0); if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 123, __pyx_L1_error)
  __pyx_v_shifts = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;

  /* "relax/potentials/coulomb/gradient.pyx":124
 * 
 * 	shifts = get_shifts(vects, real_cut_off)
 * 	if shifts == None:             # <<<<<<<<<<<<<<
 * 		shifts_no = 0
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "relax/potentials/coulomb/gradient.pyx":125
 * 	shifts = get_shifts(vects, real_cut_off)
 * 	if shifts == None:
 * 		shifts_no = 0             # <<<<<<<<<<<<<<
 * 	else:
 ...
 */
  ...
  /* "relax/potentials/coulomb/gradient.pyx":127
 * 		shifts_no = 0
 * 	else:
 * 		shifts_no = len(shifts)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "relax/potentials/coulomb/gradient.pyx":129
 * 		shifts_no = len(shifts)
 * 
 * 	nil_array = array("d",[0,0,0])             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_7cpython_5array_array), __pyx_t_6, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 129, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 129, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_nil_array = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "relax/potentials/coulomb/gradient.pyx":130
 * 
 * 	nil_array = array("d",[0,0,0])
 * 	part_drv = array("d",[0,0,0])             # <<<<<<<<<<<<<<
 * 	k_e = 14.399645351950543
 ...
 */
  ...
  PyTuple_SET_ITEM(__pyx_t_6, 1, __pyx_t_3);
  __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_7cpython_5array_array), __pyx_t_6, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 130, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 130, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_part_drv = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "relax/potentials/coulomb/gradient.pyx":131
 * 	nil_array = array("d",[0,0,0])
 * 	part_drv = array("d",[0,0,0])
 * 	k_e = 14.399645351950543             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "relax/potentials/coulomb/gradient.pyx":133
 * 	k_e = 14.399645351950543
 * 
 * 	with nogil:             # <<<<<<<<<<<<<<
 * 
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "relax/potentials/coulomb/gradient.pyx":136
 * 
 * 		# Allocate thread-local memory for distance vector
 ...
 */
        ...
        /* "relax/potentials/coulomb/gradient.pyx":138
 * 		rij = <double *> malloc(sizeof(double) * 3)
 * 
 * 		for ioni in range(N):             # <<<<<<<<<<<<<<
 * 			for ionj in range(N):
 ...
 */
        ...
        for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
          ...
          /* "relax/potentials/coulomb/gradient.pyx":139
 * 
 * 		for ioni in range(N):
 * 			for ionj in range(N):             # <<<<<<<<<<<<<<
 * 				if ioni != ionj:  # skip in case it's the same atom or it is constant
 ...
 */
          ...
          for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
            ...
            /* "relax/potentials/coulomb/gradient.pyx":140
 * 		for ioni in range(N):
 * 			for ionj in range(N):
 * 				if ioni != ionj:  # skip in case it's the same atom or it is constant             # <<<<<<<<<<<<<<
 * 
 ...
 */
            ...
            if (__pyx_t_1) {
              ...
              /* "relax/potentials/coulomb/gradient.pyx":142
 * 				if ioni != ionj:  # skip in case it's the same atom or it is constant
 * 
 * 					rij = get_distance_vector(rij, pos[ioni], pos[ionj], nil_array)             # <<<<<<<<<<<<<<
...
__pyx_t_14.data = __pyx_v_pos.data;
              __pyx_t_14.memview = __pyx_v_pos.memview;
...
__pyx_t_14.shape[0] = __pyx_v_pos.shape[1];
__pyx_t_14.strides[0] = __pyx_v_pos.strides[1];
    __pyx_t_14.suboffsets[0] = -1;

__pyx_v_rij = __pyx_f_5relax_10potentials_10operations_get_distance_vector(__pyx_v_rij, __pyx_t_7, __pyx_t_14, __pyx_v_nil_array);
              ...
              /* "relax/potentials/coulomb/gradient.pyx":143
 * 
 * 					rij = get_distance_vector(rij, pos[ioni], pos[ionj], nil_array)
 * 					dist = get_real_distance(pos[ioni], pos[ionj], nil_array)             # <<<<<<<<<<<<<<
 * 					charges_val = charges[ioni]*charges[ionj]
...
__pyx_v_dist = __pyx_f_5relax_10potentials_10operations_get_real_distance(__pyx_t_14, __pyx_t_7, __pyx_v_nil_array);
              __PYX_XDEC_MEMVIEW(&__pyx_t_14, 0);
              __pyx_t_14.memview = NULL;
              __pyx_t_14.data = NULL;
              __PYX_XDEC_MEMVIEW(&__pyx_t_7, 0);
              ...
              /* "relax/potentials/coulomb/gradient.pyx":144
 * 					rij = get_distance_vector(rij, pos[ioni], pos[ionj], nil_array)
 * 					dist = get_real_distance(pos[ioni], pos[ionj], nil_array)
 * 					charges_val = charges[ioni]*charges[ionj]             # <<<<<<<<<<<<<<
 * 
 ...
 */
              ...
              __pyx_t_16 = __pyx_v_ionj;
              __pyx_v_charges_val = ((*((int *) ( /* dim=0 */ (__pyx_v_charges.data + __pyx_t_15 * __pyx_v_charges.strides[0]) ))) * (*((int *) ( /* dim=0 */ (__pyx_v_charges.data + __pyx_t_16 * __pyx_v_charges.strides[0]) ))));

              /* "relax/potentials/coulomb/gradient.pyx":147
 * 
 * 					# Partial derivative
 ...
 */
              __pyx_v_drv = __pyx_f_5relax_10potentials_7coulomb_8gradient_erfc_drv(__pyx_v_alpha, __pyx_v_charges_val, __pyx_v_dist);

              /* "relax/potentials/coulomb/gradient.pyx":149
 * 					drv = erfc_drv(alpha, charges_val, dist)
 * 
 * 					part_drv[0] = drv*rij[0]/dist*k_e/2 # Coulomb constant             # <<<<<<<<<<<<<<
 ...
 */
              __pyx_t_17 = (__pyx_v_drv * (__pyx_v_rij[0]));
              if (unlikely(__pyx_v_dist == 0)) {
                #ifdef WITH_THREAD
                PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
                #endif
              ...
              __pyx_t_16 = 0;
              *((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_16 * __pyx_v_part_drv.strides[0]) )) = (((__pyx_t_17 / __pyx_v_dist) * __pyx_v_k_e) / 2.0);

              /* "relax/potentials/coulomb/gradient.pyx":150
 * 
 * 					part_drv[0] = drv*rij[0]/dist*k_e/2 # Coulomb constant
 * 					part_drv[1] = drv*rij[1]/dist*k_e/2             # <<<<<<<<<<<<<<
 * 					part_drv[2] = drv*rij[2]/dist*k_e/2
 * 
 */
              __pyx_t_17 = (__pyx_v_drv * (__pyx_v_rij[1]));
              if (unlikely(__pyx_v_dist == 0)) {
                #ifdef WITH_THREAD
                PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
                #endif
              ...
              *((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_16 * __pyx_v_part_drv.strides[0]) )) = (((__pyx_t_17 / __pyx_v_dist) * __pyx_v_k_e) / 2.0);
              ...
              /* "relax/potentials/coulomb/gradient.pyx":151
 * 					part_drv[0] = drv*rij[0]/dist*k_e/2 # Coulomb constant
 * 					part_drv[1] = drv*rij[1]/dist*k_e/2
 * 					part_drv[2] = drv*rij[2]/dist*k_e/2             # <<<<<<<<<<<<<<
 * 
 ...
 */
              __pyx_t_17 = (__pyx_v_drv * (__pyx_v_rij[2]));
              if (unlikely(__pyx_v_dist == 0)) {
                #ifdef WITH_THREAD
                PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
                #endif
              ...
              *((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_16 * __pyx_v_part_drv.strides[0]) )) = (((__pyx_t_17 / __pyx_v_dist) * __pyx_v_k_e) / 2.0);
              ...
              /* "relax/potentials/coulomb/gradient.pyx":154
 * 
 * 					# partial deriv with respect to ioni
 ...
 */
              ...
              __pyx_t_15 = __pyx_v_ioni;
              __pyx_t_18 = 0;
              *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_15 * __pyx_v_grad.strides[0]) ) + __pyx_t_18 * __pyx_v_grad.strides[1]) )) += (*((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_16 * __pyx_v_part_drv.strides[0]) )));

              /* "relax/potentials/coulomb/gradient.pyx":155
 * 					# partial deriv with respect to ioni
 * 					grad[ioni][0] += part_drv[0]
 * 					grad[ioni][1] += part_drv[1]             # <<<<<<<<<<<<<<
 * 					grad[ioni][2] += part_drv[2]
 ...
 */
              ...
              __pyx_t_15 = 1;
              *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_18 * __pyx_v_grad.strides[0]) ) + __pyx_t_15 * __pyx_v_grad.strides[1]) )) += (*((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_16 * __pyx_v_part_drv.strides[0]) )));

              /* "relax/potentials/coulomb/gradient.pyx":156
 * 					grad[ioni][0] += part_drv[0]
 * 					grad[ioni][1] += part_drv[1]
 * 					grad[ioni][2] += part_drv[2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
              ...
              *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_15 * __pyx_v_grad.strides[0]) ) + __pyx_t_18 * __pyx_v_grad.strides[1]) )) += (*((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_16 * __pyx_v_part_drv.strides[0]) )));
              ...
              /* "relax/potentials/coulomb/gradient.pyx":159
 * 
 * 					# partial deriv with respect to ionj
 ...
 */
              ...
              *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_18 * __pyx_v_grad.strides[0]) ) + __pyx_t_15 * __pyx_v_grad.strides[1]) )) -= (*((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_16 * __pyx_v_part_drv.strides[0]) )));
              ...
              /* "relax/potentials/coulomb/gradient.pyx":160
 * 					# partial deriv with respect to ionj
 * 					grad[ionj][0] -= part_drv[0]
 * 					grad[ionj][1] -= part_drv[1]             # <<<<<<<<<<<<<<
 * 					grad[ionj][2] -= part_drv[2]
 ...
 */
              __pyx_t_16 = 1;
              __pyx_t_15 = __pyx_v_ionj;
              __pyx_t_18 = 1;
              *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_15 * __pyx_v_grad.strides[0]) ) + __pyx_t_18 * __pyx_v_grad.strides[1]) )) -= (*((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_16 * __pyx_v_part_drv.strides[0]) )));

              /* "relax/potentials/coulomb/gradient.pyx":161
 * 					grad[ionj][0] -= part_drv[0]
 * 					grad[ionj][1] -= part_drv[1]
 * 					grad[ionj][2] -= part_drv[2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
              ...
              *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_18 * __pyx_v_grad.strides[0]) ) + __pyx_t_15 * __pyx_v_grad.strides[1]) )) -= (*((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_16 * __pyx_v_part_drv.strides[0]) )));
              ...
              /* "relax/potentials/coulomb/gradient.pyx":164
 * 
 * 					# deriv with respect to strain epsilon_lm (Ln not present in summand)
 * 					for l in range(3):             # <<<<<<<<<<<<<<
 * 						for m in range(l,3):
 ...
 */
              for (__pyx_t_19 = 0; __pyx_t_19 < 3; __pyx_t_19+=1) {
                ...
                /* "relax/potentials/coulomb/gradient.pyx":165
 * 					# deriv with respect to strain epsilon_lm (Ln not present in summand)
 * 					for l in range(3):
 * 						for m in range(l,3):             # <<<<<<<<<<<<<<
 * 							stresses[l][m] += part_drv[l]*(pos[ioni][m]-pos[ionj][m])
 * 
 */
                for (__pyx_t_20 = __pyx_v_l; __pyx_t_20 < 3; __pyx_t_20+=1) {
                  __pyx_v_m = __pyx_t_20;

                  /* "relax/potentials/coulomb/gradient.pyx":166
 * 					for l in range(3):
 * 						for m in range(l,3):
 * 							stresses[l][m] += part_drv[l]*(pos[ioni][m]-pos[ionj][m])             # <<<<<<<<<<<<<<
 * 
 ...
 */
                  ...
                  __pyx_t_21 = __pyx_v_ionj;
                  __pyx_t_22 = __pyx_v_m;
                  __pyx_t_23 = __pyx_v_l;
                  __pyx_t_24 = __pyx_v_m;
                  *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_stresses.data + __pyx_t_23 * __pyx_v_stresses.strides[0]) ) + __pyx_t_24 * __pyx_v_stresses.strides[1]) )) += ((*((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_16 * __pyx_v_part_drv.strides[0]) ))) * ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_pos.data + __pyx_t_15 * __pyx_v_pos.strides[0]) ) + __pyx_t_18 * __pyx_v_pos.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_pos.data + __pyx_t_21 * __pyx_v_pos.strides[0]) ) + __pyx_t_22 * __pyx_v_pos.strides[1]) )))));

                  /* "relax/potentials/coulomb/gradient.pyx":169
 * 
 * 							# Add the following if alpha is not constant
 * 							if (l==m):             # <<<<<<<<<<<<<<
 * 								term = exp(-alpha*alpha*dist*dist)
 ...
 */
                  ...
                  if (__pyx_t_1) {
                    ...
                    /* "relax/potentials/coulomb/gradient.pyx":170
 * 							# Add the following if alpha is not constant
 * 							if (l==m):
 * 								term = exp(-alpha*alpha*dist*dist)             # <<<<<<<<<<<<<<
 * 								drv = charges_val*k_e * \
 ...
 */
                    ...
                    /* "relax/potentials/coulomb/gradient.pyx":172
 * 								term = exp(-alpha*alpha*dist*dist)
 * 								drv = charges_val*k_e * \
 * 									-alpha_drv*term/sqrt(pi)             # <<<<<<<<<<<<<<
 * 								stresses[l][m] += drv
 * 
 */
                    __pyx_t_17 = (((__pyx_v_charges_val * __pyx_v_k_e) * (-__pyx_v_alpha_drv)) * __pyx_v_term);
                    __pyx_t_25 = sqrt(M_PI);
                    ...
                    __pyx_v_drv = (__pyx_t_17 / __pyx_t_25);

                    /* "relax/potentials/coulomb/gradient.pyx":173
 * 								drv = charges_val*k_e * \
 * 									-alpha_drv*term/sqrt(pi)
 * 								stresses[l][m] += drv             # <<<<<<<<<<<<<<
 * 
 ...
 */
                    ...
                    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_stresses.data + __pyx_t_22 * __pyx_v_stresses.strides[0]) ) + __pyx_t_21 * __pyx_v_stresses.strides[1]) )) += __pyx_v_drv;
 ...
 */
            ...
            /* "relax/potentials/coulomb/gradient.pyx":176
 * 
 * 				# take care of the rest lattice (+ Ln)
 ...
 */
            __pyx_t_19 = __pyx_v_shifts_no;
            __pyx_t_20 = __pyx_t_19;
            for (__pyx_t_26 = 0; __pyx_t_26 < __pyx_t_20; __pyx_t_26+=1) {
              __pyx_v_shift = __pyx_t_26;

              /* "relax/potentials/coulomb/gradient.pyx":177
 * 				# take care of the rest lattice (+ Ln)
 * 				for shift in range(shifts_no):
 * 					rij = get_distance_vector(rij, pos[ioni], pos[ionj], shifts[shift])             # <<<<<<<<<<<<<<
 * 					dist = get_real_distance(pos[ioni], pos[ionj], shifts[shift])
...
__pyx_t_27.data = __pyx_v_shifts.data;
              __pyx_t_27.memview = __pyx_v_shifts.memview;
...
__pyx_t_27.shape[0] = __pyx_v_shifts.shape[1];
__pyx_t_27.strides[0] = __pyx_v_shifts.strides[1];
    __pyx_t_27.suboffsets[0] = -1;

__pyx_v_rij = __pyx_f_5relax_10potentials_10operations_get_distance_vector(__pyx_v_rij, __pyx_t_7, __pyx_t_14, __pyx_t_27);
              __PYX_XDEC_MEMVIEW(&__pyx_t_7, 0);
              __pyx_t_7.memview = NULL;
              __pyx_t_7.data = NULL;
              __PYX_XDEC_MEMVIEW(&__pyx_t_14, 0);
              ...
              /* "relax/potentials/coulomb/gradient.pyx":178
 * 				for shift in range(shifts_no):
 * 					rij = get_distance_vector(rij, pos[ioni], pos[ionj], shifts[shift])
 * 					dist = get_real_distance(pos[ioni], pos[ionj], shifts[shift])             # <<<<<<<<<<<<<<
 * 					charges_val = charges[ioni]*charges[ionj]
 * 
 */
              __pyx_t_27.data = __pyx_v_pos.data;
              __pyx_t_27.memview = __pyx_v_pos.memview;
              __PYX_INC_MEMVIEW(&__pyx_t_27, 0);
              {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_ioni;
    Py_ssize_t __pyx_tmp_stride = __pyx_v_pos.strides[0];
...
__pyx_t_27.shape[0] = __pyx_v_pos.shape[1];
__pyx_t_27.strides[0] = __pyx_v_pos.strides[1];
    __pyx_t_27.suboffsets[0] = -1;
...
__pyx_t_7.data = __pyx_v_shifts.data;
              __pyx_t_7.memview = __pyx_v_shifts.memview;
              __PYX_INC_MEMVIEW(&__pyx_t_7, 0);
              {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_shift;
    Py_ssize_t __pyx_tmp_stride = __pyx_v_shifts.strides[0];
...
__pyx_t_7.shape[0] = __pyx_v_shifts.shape[1];
__pyx_t_7.strides[0] = __pyx_v_shifts.strides[1];
    __pyx_t_7.suboffsets[0] = -1;

__pyx_v_dist = __pyx_f_5relax_10potentials_10operations_get_real_distance(__pyx_t_27, __pyx_t_14, __pyx_t_7);
              __PYX_XDEC_MEMVIEW(&__pyx_t_27, 0);
              __pyx_t_27.memview = NULL;
              __pyx_t_27.data = NULL;
              __PYX_XDEC_MEMVIEW(&__pyx_t_14, 0);
              ...
              /* "relax/potentials/coulomb/gradient.pyx":179
 * 					rij = get_distance_vector(rij, pos[ioni], pos[ionj], shifts[shift])
 * 					dist = get_real_distance(pos[ioni], pos[ionj], shifts[shift])
 * 					charges_val = charges[ioni]*charges[ionj]             # <<<<<<<<<<<<<<
 * 
 ...
 */
              __pyx_t_21 = __pyx_v_ioni;
              __pyx_t_22 = __pyx_v_ionj;
              __pyx_v_charges_val = ((*((int *) ( /* dim=0 */ (__pyx_v_charges.data + __pyx_t_21 * __pyx_v_charges.strides[0]) ))) * (*((int *) ( /* dim=0 */ (__pyx_v_charges.data + __pyx_t_22 * __pyx_v_charges.strides[0]) ))));

              /* "relax/potentials/coulomb/gradient.pyx":182
 * 
 * 					# Avoid division by zero
 * 					if dist == 0:             # <<<<<<<<<<<<<<
 * 						dist = DBL_EPSILON
 ...
 */
              ...
              if (__pyx_t_1) {
                ...
                /* "relax/potentials/coulomb/gradient.pyx":183
 * 					# Avoid division by zero
 * 					if dist == 0:
 * 						dist = DBL_EPSILON             # <<<<<<<<<<<<<<
 * 
 ...
 */
              ...
              /* "relax/potentials/coulomb/gradient.pyx":186
 * 
 * 					# Partial derivative
 * 					drv = erfc_drv(alpha, charges_val, dist)             # <<<<<<<<<<<<<<
 * 
 ...
 */
              ...
              /* "relax/potentials/coulomb/gradient.pyx":188
 * 					drv = erfc_drv(alpha, charges_val, dist)
 * 
 * 					part_drv[0] = drv*rij[0]/dist*k_e/2 # Coulomb constant             # <<<<<<<<<<<<<<
 * 					part_drv[1] = drv*rij[1]/dist*k_e/2
 * 					part_drv[2] = drv*rij[2]/dist*k_e/2
 */
              __pyx_t_25 = (__pyx_v_drv * (__pyx_v_rij[0]));
              if (unlikely(__pyx_v_dist == 0)) {
                #ifdef WITH_THREAD
                PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
                #endif
              ...
              __pyx_t_22 = 0;
              *((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_22 * __pyx_v_part_drv.strides[0]) )) = (((__pyx_t_25 / __pyx_v_dist) * __pyx_v_k_e) / 2.0);

              /* "relax/potentials/coulomb/gradient.pyx":189
 * 
 * 					part_drv[0] = drv*rij[0]/dist*k_e/2 # Coulomb constant
 * 					part_drv[1] = drv*rij[1]/dist*k_e/2             # <<<<<<<<<<<<<<
 * 					part_drv[2] = drv*rij[2]/dist*k_e/2
 * 
 */
              __pyx_t_25 = (__pyx_v_drv * (__pyx_v_rij[1]));
              if (unlikely(__pyx_v_dist == 0)) {
                #ifdef WITH_THREAD
                PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
                #endif
                ...
                __Pyx_PyGILState_Release(__pyx_gilstate_save);
                #endif
                __PYX_ERR(0, 189, __pyx_L8_error)
              }
              __pyx_t_22 = 1;
              *((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_22 * __pyx_v_part_drv.strides[0]) )) = (((__pyx_t_25 / __pyx_v_dist) * __pyx_v_k_e) / 2.0);

              /* "relax/potentials/coulomb/gradient.pyx":190
 * 					part_drv[0] = drv*rij[0]/dist*k_e/2 # Coulomb constant
 * 					part_drv[1] = drv*rij[1]/dist*k_e/2
 * 					part_drv[2] = drv*rij[2]/dist*k_e/2             # <<<<<<<<<<<<<<
 * 
 * 					# partial deriv with respect to ioni
 */
              __pyx_t_25 = (__pyx_v_drv * (__pyx_v_rij[2]));
              if (unlikely(__pyx_v_dist == 0)) {
                #ifdef WITH_THREAD
                PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
                #endif
              ...
              *((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_22 * __pyx_v_part_drv.strides[0]) )) = (((__pyx_t_25 / __pyx_v_dist) * __pyx_v_k_e) / 2.0);
              ...
              /* "relax/potentials/coulomb/gradient.pyx":193
 * 
 * 					# partial deriv with respect to ioni
 * 					grad[ioni][0] += part_drv[0]             # <<<<<<<<<<<<<<
 * 					grad[ioni][1] += part_drv[1]
 ...
 */
              ...
              __pyx_t_21 = __pyx_v_ioni;
              __pyx_t_18 = 0;
              *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_21 * __pyx_v_grad.strides[0]) ) + __pyx_t_18 * __pyx_v_grad.strides[1]) )) += (*((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_22 * __pyx_v_part_drv.strides[0]) )));

              /* "relax/potentials/coulomb/gradient.pyx":194
 * 					# partial deriv with respect to ioni
 * 					grad[ioni][0] += part_drv[0]
 * 					grad[ioni][1] += part_drv[1]             # <<<<<<<<<<<<<<
 * 					grad[ioni][2] += part_drv[2]
 ...
 */
              ...
              __pyx_t_18 = __pyx_v_ioni;
              __pyx_t_21 = 1;
              *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_18 * __pyx_v_grad.strides[0]) ) + __pyx_t_21 * __pyx_v_grad.strides[1]) )) += (*((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_22 * __pyx_v_part_drv.strides[0]) )));

              /* "relax/potentials/coulomb/gradient.pyx":195
 * 					grad[ioni][0] += part_drv[0]
 * 					grad[ioni][1] += part_drv[1]
 * 					grad[ioni][2] += part_drv[2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
              ...
              *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_21 * __pyx_v_grad.strides[0]) ) + __pyx_t_18 * __pyx_v_grad.strides[1]) )) += (*((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_22 * __pyx_v_part_drv.strides[0]) )));
              ...
              /* "relax/potentials/coulomb/gradient.pyx":198
 * 
 * 					# partial deriv with respect to ionj
 * 					grad[ionj][0] -= part_drv[0]             # <<<<<<<<<<<<<<
 * 					grad[ionj][1] -= part_drv[1]
 ...
 */
              ...
              *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_18 * __pyx_v_grad.strides[0]) ) + __pyx_t_21 * __pyx_v_grad.strides[1]) )) -= (*((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_22 * __pyx_v_part_drv.strides[0]) )));
              ...
              /* "relax/potentials/coulomb/gradient.pyx":199
 * 					# partial deriv with respect to ionj
 * 					grad[ionj][0] -= part_drv[0]
 * 					grad[ionj][1] -= part_drv[1]             # <<<<<<<<<<<<<<
 * 					grad[ionj][2] -= part_drv[2]
 ...
 */
              ...
              *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_21 * __pyx_v_grad.strides[0]) ) + __pyx_t_18 * __pyx_v_grad.strides[1]) )) -= (*((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_22 * __pyx_v_part_drv.strides[0]) )));
              ...
              /* "relax/potentials/coulomb/gradient.pyx":200
 * 					grad[ionj][0] -= part_drv[0]
 * 					grad[ionj][1] -= part_drv[1]
 * 					grad[ionj][2] -= part_drv[2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
              ...
              *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_18 * __pyx_v_grad.strides[0]) ) + __pyx_t_21 * __pyx_v_grad.strides[1]) )) -= (*((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_22 * __pyx_v_part_drv.strides[0]) )));
              ...
              /* "relax/potentials/coulomb/gradient.pyx":203
 * 
 * 					# deriv with respect to strain epsilon_lm (Ln present in summand)
 * 					for l in range(3):             # <<<<<<<<<<<<<<
 * 						for m in range(l,3):
 ...
 */
              for (__pyx_t_28 = 0; __pyx_t_28 < 3; __pyx_t_28+=1) {
                ...
                /* "relax/potentials/coulomb/gradient.pyx":204
 * 					# deriv with respect to strain epsilon_lm (Ln present in summand)
 * 					for l in range(3):
 * 						for m in range(l,3):             # <<<<<<<<<<<<<<
 * 							stresses[l][m] += part_drv[l]*( pos[ioni][m]+shifts[shift][m]-pos[ionj][m] )
 * 
 */
                for (__pyx_t_29 = __pyx_v_l; __pyx_t_29 < 3; __pyx_t_29+=1) {
                  __pyx_v_m = __pyx_t_29;

                  /* "relax/potentials/coulomb/gradient.pyx":205
 * 					for l in range(3):
 * 						for m in range(l,3):
 * 							stresses[l][m] += part_drv[l]*( pos[ioni][m]+shifts[shift][m]-pos[ionj][m] )             # <<<<<<<<<<<<<<
 * 
 ...
 */
                  ...
                  __pyx_t_21 = __pyx_v_ioni;
                  __pyx_t_18 = __pyx_v_m;
                  __pyx_t_15 = __pyx_v_shift;
                  __pyx_t_16 = __pyx_v_m;
                  __pyx_t_24 = __pyx_v_ionj;
                  __pyx_t_23 = __pyx_v_m;
                  __pyx_t_30 = __pyx_v_l;
                  __pyx_t_31 = __pyx_v_m;
                  *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_stresses.data + __pyx_t_30 * __pyx_v_stresses.strides[0]) ) + __pyx_t_31 * __pyx_v_stresses.strides[1]) )) += ((*((double *) ( /* dim=0 */ (__pyx_v_part_drv.data + __pyx_t_22 * __pyx_v_part_drv.strides[0]) ))) * (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_pos.data + __pyx_t_21 * __pyx_v_pos.strides[0]) ) + __pyx_t_18 * __pyx_v_pos.strides[1]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_shifts.data + __pyx_t_15 * __pyx_v_shifts.strides[0]) ) + __pyx_t_16 * __pyx_v_shifts.strides[1]) )))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_pos.data + __pyx_t_24 * __pyx_v_pos.strides[0]) ) + __pyx_t_23 * __pyx_v_pos.strides[1]) )))));

                  /* "relax/potentials/coulomb/gradient.pyx":207
 * 							stresses[l][m] += part_drv[l]*( pos[ioni][m]+shifts[shift][m]-pos[ionj][m] )
 * 
 * 							if (l==m):             # <<<<<<<<<<<<<<
 * 								term = exp(-alpha*alpha*dist*dist)
 ...
 */
                  ...
                  if (__pyx_t_1) {
                    ...
                    /* "relax/potentials/coulomb/gradient.pyx":208
 * 
 * 							if (l==m):
 * 								term = exp(-alpha*alpha*dist*dist)             # <<<<<<<<<<<<<<
 * 								drv = charges_val*k_e* \
 ...
 */
                    ...
                    /* "relax/potentials/coulomb/gradient.pyx":210
 * 								term = exp(-alpha*alpha*dist*dist)
 * 								drv = charges_val*k_e* \
 * 									-alpha_drv*term/sqrt(pi)             # <<<<<<<<<<<<<<
 * 								stresses[l][m] += drv
 ...
 */
                    __pyx_t_25 = (((__pyx_v_charges_val * __pyx_v_k_e) * (-__pyx_v_alpha_drv)) * __pyx_v_term);
                    __pyx_t_17 = sqrt(M_PI);
                    ...
                    __pyx_v_drv = (__pyx_t_25 / __pyx_t_17);

                    /* "relax/potentials/coulomb/gradient.pyx":211
 * 								drv = charges_val*k_e* \
 * 									-alpha_drv*term/sqrt(pi)
 * 								stresses[l][m] += drv             # <<<<<<<<<<<<<<
 * 		# Deallocate distance vector
 ...
 */
                    __pyx_t_23 = __pyx_v_l;
                    __pyx_t_24 = __pyx_v_m;
                    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_stresses.data + __pyx_t_23 * __pyx_v_stresses.strides[0]) ) + __pyx_t_24 * __pyx_v_stresses.strides[1]) )) += __pyx_v_drv;
 ...
 */
        ...
        /* "relax/potentials/coulomb/gradient.pyx":213
 * 								stresses[l][m] += drv
 * 		# Deallocate distance vector
 * 		free(rij)             # <<<<<<<<<<<<<<
 * 		rij = NULL
 ...
 */
        ...
        /* "relax/potentials/coulomb/gradient.pyx":214
 * 		# Deallocate distance vector
 * 		free(rij)
 * 		rij = NULL             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "relax/potentials/coulomb/gradient.pyx":216
 * 		rij = NULL
 * 
 * 	return grad             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __PYX_INC_MEMVIEW(&__pyx_v_grad, 0);
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("relax.potentials.coulomb.gradient.real_drv", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_part_drv, 1);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "relax/potentials/coulomb/gradient.pyx":221
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
...
static __Pyx_memviewslice __pyx_f_5relax_10potentials_7coulomb_8gradient_recip_drv(__Pyx_memviewslice __pyx_v_grad, __Pyx_memviewslice __pyx_v_stresses, __Pyx_memviewslice __pyx_v_pos, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_vects, __Pyx_memviewslice __pyx_v_rvects, __Pyx_memviewslice __pyx_v_charges, double __pyx_v_recip_cut_off, double __pyx_v_alpha, double __pyx_v_alpha_drv, double __pyx_v_volume, int __pyx_v_N) {
  Py_ssize_t __pyx_v_ioni;
  Py_ssize_t __pyx_v_ionj;
  Py_ssize_t __pyx_v_shift;
  Py_ssize_t __pyx_v_l;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("recip_drv", 0);

  /* "relax/potentials/coulomb/gradient.pyx":253
 ...
 */
  ...
  /* "relax/potentials/coulomb/gradient.pyx":255
 * 	cdef double k_e = 14.399645351950543 # Coulomb constant
 * 
 * 	shifts = get_shifts(rvects, recip_cut_off)             # <<<<<<<<<<<<<<
 * 	nil_array = array("d",[0,0,0])
 * 
 */
  __pyx_t_1 = __pyx_f_5relax_10potentials_6cutoff_inflated_cell_truncation(__pyx_v_rvects, __pyx_v_recip_cut_off, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 255, __pyx_L1_error)
  __pyx_v_shifts = __pyx_t_1;
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;

  /* "relax/potentials/coulomb/gradient.pyx":256
 * 
 * 	shifts = get_shifts(rvects, recip_cut_off)
 * 	nil_array = array("d",[0,0,0])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = PyList_New(3); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 256, __pyx_L1_error)
  ...
  __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_7cpython_5array_array), __pyx_t_3, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 256, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 256, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_nil_array = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;

  /* "relax/potentials/coulomb/gradient.pyx":259
 * 
 * 	# Check interactions with neighbouring cells
 * 	if shifts == None:             # <<<<<<<<<<<<<<
 * 		shifts_no = 0
 * 	else:
 */
  __pyx_t_5 = ((((PyObject *) __pyx_v_shifts.memview) == Py_None) != 0);
  if (__pyx_t_5) {

    /* "relax/potentials/coulomb/gradient.pyx":260
 * 	# Check interactions with neighbouring cells
 * 	if shifts == None:
 * 		shifts_no = 0             # <<<<<<<<<<<<<<
 * 	else:
 ...
 */
  ...
  /* "relax/potentials/coulomb/gradient.pyx":262
 * 		shifts_no = 0
 * 	else:
 * 		shifts_no = len(shifts)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "relax/potentials/coulomb/gradient.pyx":264
 * 		shifts_no = len(shifts)
 * 
 * 	with nogil:             # <<<<<<<<<<<<<<
 * 
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "relax/potentials/coulomb/gradient.pyx":267
 * 
 * 		# Allocate thread-local memory for distance vector
 * 		rij = <double *> malloc(sizeof(double) * 3)             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "relax/potentials/coulomb/gradient.pyx":269
 * 		rij = <double *> malloc(sizeof(double) * 3)
 * 
 * 		for ioni in range(N):             # <<<<<<<<<<<<<<
 * 			for ionj in range(N):
 ...
 */
        ...
        for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
          __pyx_v_ioni = __pyx_t_9;

          /* "relax/potentials/coulomb/gradient.pyx":270
 * 
 * 		for ioni in range(N):
 * 			for ionj in range(N):             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
            __pyx_v_ionj = __pyx_t_12;

            /* "relax/potentials/coulomb/gradient.pyx":273
 * 
 * 				# Get distance vector
 * 				rij = get_distance_vector(rij, pos[ioni], pos[ionj], nil_array)             # <<<<<<<<<<<<<<
 * 
 * 				for shift in range(shifts_no):
 */
            __pyx_t_4.data = __pyx_v_pos.data;
            __pyx_t_4.memview = __pyx_v_pos.memview;
...
__pyx_t_4.shape[0] = __pyx_v_pos.shape[1];
__pyx_t_4.strides[0] = __pyx_v_pos.strides[1];
    __pyx_t_4.suboffsets[0] = -1;

__pyx_t_13.data = __pyx_v_pos.data;
            __pyx_t_13.memview = __pyx_v_pos.memview;
...
__pyx_t_13.shape[0] = __pyx_v_pos.shape[1];
__pyx_t_13.strides[0] = __pyx_v_pos.strides[1];
    __pyx_t_13.suboffsets[0] = -1;

__pyx_v_rij = __pyx_f_5relax_10potentials_10operations_get_distance_vector(__pyx_v_rij, __pyx_t_4, __pyx_t_13, __pyx_v_nil_array);
            ...
            /* "relax/potentials/coulomb/gradient.pyx":275
 * 				rij = get_distance_vector(rij, pos[ioni], pos[ionj], nil_array)
 * 
 * 				for shift in range(shifts_no):             # <<<<<<<<<<<<<<
 * 					# shift on 2nd power
 ...
 */
            __pyx_t_14 = __pyx_v_shifts_no;
            __pyx_t_15 = __pyx_t_14;
            for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
              __pyx_v_shift = __pyx_t_16;

              /* "relax/potentials/coulomb/gradient.pyx":277
 * 				for shift in range(shifts_no):
 * 					# shift on 2nd power
 * 					k_2 = shifts[shift, 0]*shifts[shift, 0]+ \             # <<<<<<<<<<<<<<
 ...
 */
              __pyx_t_17 = __pyx_v_shift;
              __pyx_t_18 = 0;
              __pyx_t_19 = __pyx_v_shift;
              __pyx_t_20 = 0;

              /* "relax/potentials/coulomb/gradient.pyx":278
 * 					# shift on 2nd power
 * 					k_2 = shifts[shift, 0]*shifts[shift, 0]+ \
 * 							shifts[shift, 1]*shifts[shift, 1]+ \             # <<<<<<<<<<<<<<
 * 							shifts[shift, 2]*shifts[shift, 2]
 * 
 */
              __pyx_t_21 = __pyx_v_shift;
              __pyx_t_22 = 1;
              __pyx_t_23 = __pyx_v_shift;
              __pyx_t_24 = 1;

              /* "relax/potentials/coulomb/gradient.pyx":279
 * 					k_2 = shifts[shift, 0]*shifts[shift, 0]+ \
 * 							shifts[shift, 1]*shifts[shift, 1]+ \
 * 							shifts[shift, 2]*shifts[shift, 2]             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
              __pyx_v_k_2 = ((((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_shifts.data + __pyx_t_17 * __pyx_v_shifts.strides[0]) ) + __pyx_t_18 * __pyx_v_shifts.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_shifts.data + __pyx_t_19 * __pyx_v_shifts.strides[0]) ) + __pyx_t_20 * __pyx_v_shifts.strides[1]) )))) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_shifts.data + __pyx_t_21 * __pyx_v_shifts.strides[0]) ) + __pyx_t_22 * __pyx_v_shifts.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_shifts.data + __pyx_t_23 * __pyx_v_shifts.strides[0]) ) + __pyx_t_24 * __pyx_v_shifts.strides[1]) ))))) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_shifts.data + __pyx_t_25 * __pyx_v_shifts.strides[0]) ) + __pyx_t_26 * __pyx_v_shifts.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_shifts.data + __pyx_t_27 * __pyx_v_shifts.strides[0]) ) + __pyx_t_28 * __pyx_v_shifts.strides[1]) )))));

              /* "relax/potentials/coulomb/gradient.pyx":281
 * 							shifts[shift, 2]*shifts[shift, 2]
 * 
 * 					krij = get_recip_distance(rij, shifts[shift])             # <<<<<<<<<<<<<<
 ...
 */
              __pyx_t_13.data = __pyx_v_shifts.data;
              __pyx_t_13.memview = __pyx_v_shifts.memview;
              __PYX_INC_MEMVIEW(&__pyx_t_13, 0);
              {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_shift;
    Py_ssize_t __pyx_tmp_stride = __pyx_v_shifts.strides[0];
...
__pyx_t_13.shape[0] = __pyx_v_shifts.shape[1];
__pyx_t_13.strides[0] = __pyx_v_shifts.strides[1];
    __pyx_t_13.suboffsets[0] = -1;

__pyx_v_krij = __pyx_f_5relax_10potentials_10operations_get_recip_distance(__pyx_v_rij, __pyx_t_13);
              __PYX_XDEC_MEMVIEW(&__pyx_t_13, 0);
              __pyx_t_13.memview = NULL;
              __pyx_t_13.data = NULL;

              /* "relax/potentials/coulomb/gradient.pyx":282
 * 
 * 					krij = get_recip_distance(rij, shifts[shift])
 * 					term = exp(-k_2/(4*pow(alpha,2)))             # <<<<<<<<<<<<<<
 * 					drv = - charges[ioni]*charges[ionj] * \
 ...
 */
              __pyx_t_29 = (-__pyx_v_k_2);
              __pyx_t_30 = (4.0 * pow(__pyx_v_alpha, 2.0));
              ...
              __pyx_v_term = exp((__pyx_t_29 / __pyx_t_30));

              /* "relax/potentials/coulomb/gradient.pyx":283
 * 					krij = get_recip_distance(rij, shifts[shift])
 * 					term = exp(-k_2/(4*pow(alpha,2)))
 * 					drv = - charges[ioni]*charges[ionj] * \             # <<<<<<<<<<<<<<
 * 									   2*pi*k_e*term*sin(krij)/(k_2*volume)
 ...
 */
              ...
              __pyx_t_27 = __pyx_v_ionj;

              /* "relax/potentials/coulomb/gradient.pyx":284
 * 					term = exp(-k_2/(4*pow(alpha,2)))
 * 					drv = - charges[ioni]*charges[ionj] * \
 * 									   2*pi*k_e*term*sin(krij)/(k_2*volume)             # <<<<<<<<<<<<<<
 * 
 * 					# partial deriv with respect to ioni
 */
              __pyx_t_30 = (((((((-(*((int *) ( /* dim=0 */ (__pyx_v_charges.data + __pyx_t_28 * __pyx_v_charges.strides[0]) )))) * (*((int *) ( /* dim=0 */ (__pyx_v_charges.data + __pyx_t_27 * __pyx_v_charges.strides[0]) )))) * 2) * M_PI) * __pyx_v_k_e) * __pyx_v_term) * sin(__pyx_v_krij));
              __pyx_t_29 = (__pyx_v_k_2 * __pyx_v_volume);
              ...
              __pyx_v_drv = (__pyx_t_30 / __pyx_t_29);

              /* "relax/potentials/coulomb/gradient.pyx":287
 * 
 * 					# partial deriv with respect to ioni
 ...
 */
              __pyx_t_27 = __pyx_v_shift;
              __pyx_t_28 = 0;
              __pyx_t_26 = __pyx_v_ioni;
              __pyx_t_25 = 0;
              *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_26 * __pyx_v_grad.strides[0]) ) + __pyx_t_25 * __pyx_v_grad.strides[1]) )) += (__pyx_v_drv * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_shifts.data + __pyx_t_27 * __pyx_v_shifts.strides[0]) ) + __pyx_t_28 * __pyx_v_shifts.strides[1]) ))));

              /* "relax/potentials/coulomb/gradient.pyx":288
 * 					# partial deriv with respect to ioni
 * 					grad[ioni][0] += drv*shifts[shift,0]
 * 					grad[ioni][1] += drv*shifts[shift,1]             # <<<<<<<<<<<<<<
 * 					grad[ioni][2] += drv*shifts[shift,2]
 ...
 */
              ...
              __pyx_t_27 = 1;
              __pyx_t_25 = __pyx_v_ioni;
              __pyx_t_26 = 1;
              *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_25 * __pyx_v_grad.strides[0]) ) + __pyx_t_26 * __pyx_v_grad.strides[1]) )) += (__pyx_v_drv * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_shifts.data + __pyx_t_28 * __pyx_v_shifts.strides[0]) ) + __pyx_t_27 * __pyx_v_shifts.strides[1]) ))));

              /* "relax/potentials/coulomb/gradient.pyx":289
 * 					grad[ioni][0] += drv*shifts[shift,0]
 * 					grad[ioni][1] += drv*shifts[shift,1]
 * 					grad[ioni][2] += drv*shifts[shift,2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
              ...
              *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_26 * __pyx_v_grad.strides[0]) ) + __pyx_t_25 * __pyx_v_grad.strides[1]) )) += (__pyx_v_drv * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_shifts.data + __pyx_t_27 * __pyx_v_shifts.strides[0]) ) + __pyx_t_28 * __pyx_v_shifts.strides[1]) ))));
              ...
              /* "relax/potentials/coulomb/gradient.pyx":292
 * 
 * 					# partial deriv with respect to ionj
 ...
 */
              __pyx_t_28 = __pyx_v_shift;
              __pyx_t_27 = 0;
              __pyx_t_25 = __pyx_v_ionj;
              __pyx_t_26 = 0;
              *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_25 * __pyx_v_grad.strides[0]) ) + __pyx_t_26 * __pyx_v_grad.strides[1]) )) -= (__pyx_v_drv * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_shifts.data + __pyx_t_28 * __pyx_v_shifts.strides[0]) ) + __pyx_t_27 * __pyx_v_shifts.strides[1]) ))));

              /* "relax/potentials/coulomb/gradient.pyx":293
 * 					# partial deriv with respect to ionj
 * 					grad[ionj][0] -= drv*shifts[shift,0]
 * 					grad[ionj][1] -= drv*shifts[shift,1]             # <<<<<<<<<<<<<<
 * 					grad[ionj][2] -= drv*shifts[shift,2]
 ...
 */
              ...
              *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_26 * __pyx_v_grad.strides[0]) ) + __pyx_t_25 * __pyx_v_grad.strides[1]) )) -= (__pyx_v_drv * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_shifts.data + __pyx_t_27 * __pyx_v_shifts.strides[0]) ) + __pyx_t_28 * __pyx_v_shifts.strides[1]) ))));
              ...
              /* "relax/potentials/coulomb/gradient.pyx":294
 * 					grad[ionj][0] -= drv*shifts[shift,0]
 * 					grad[ionj][1] -= drv*shifts[shift,1]
 * 					grad[ionj][2] -= drv*shifts[shift,2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
              ...
              *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_25 * __pyx_v_grad.strides[0]) ) + __pyx_t_26 * __pyx_v_grad.strides[1]) )) -= (__pyx_v_drv * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_shifts.data + __pyx_t_28 * __pyx_v_shifts.strides[0]) ) + __pyx_t_27 * __pyx_v_shifts.strides[1]) ))));
              ...
              /* "relax/potentials/coulomb/gradient.pyx":296
 * 					grad[ionj][2] -= drv*shifts[shift,2]
 * 
 * 					drv = 2*pi*k_e/volume * \             # <<<<<<<<<<<<<<
 ...
 * 						term/k_2 * cos(krij)
 */
              __pyx_t_29 = ((2.0 * M_PI) * __pyx_v_k_e);
              ...
              /* "relax/potentials/coulomb/gradient.pyx":297
 * 
 * 					drv = 2*pi*k_e/volume * \
 * 						charges[ioni]*charges[ionj] * \             # <<<<<<<<<<<<<<
 * 						term/k_2 * cos(krij)
 ...
 * 
 */
              __pyx_t_30 = ((((__pyx_t_29 / __pyx_v_volume) * (*((int *) ( /* dim=0 */ (__pyx_v_charges.data + __pyx_t_27 * __pyx_v_charges.strides[0]) )))) * (*((int *) ( /* dim=0 */ (__pyx_v_charges.data + __pyx_t_28 * __pyx_v_charges.strides[0]) )))) * __pyx_v_term);

              /* "relax/potentials/coulomb/gradient.pyx":298
 * 					drv = 2*pi*k_e/volume * \
 * 						charges[ioni]*charges[ionj] * \
 * 						term/k_2 * cos(krij)             # <<<<<<<<<<<<<<
 * 
 ...
 */
              ...
              __pyx_v_drv = ((__pyx_t_30 / __pyx_v_k_2) * cos(__pyx_v_krij));

              /* "relax/potentials/coulomb/gradient.pyx":300
 * 						term/k_2 * cos(krij)
 * 
 * 					for l in range(3):             # <<<<<<<<<<<<<<
 * 						for m in range(l,3):
 ...
 */
              for (__pyx_t_31 = 0; __pyx_t_31 < 3; __pyx_t_31+=1) {
                ...
                /* "relax/potentials/coulomb/gradient.pyx":301
 * 
 * 					for l in range(3):
 * 						for m in range(l,3):             # <<<<<<<<<<<<<<
 * 							# deriv with respect to strain epsilon_lm
 * 							stresses[l][m] += \
 */
                for (__pyx_t_32 = __pyx_v_l; __pyx_t_32 < 3; __pyx_t_32+=1) {
                  __pyx_v_m = __pyx_t_32;

                  /* "relax/potentials/coulomb/gradient.pyx":305
 * 							stresses[l][m] += \
 * 								drv*(
 ...
 * 									)
 */
                  __pyx_t_30 = ((2.0 * __pyx_v_alpha) * __pyx_v_alpha);
                  if (unlikely(__pyx_t_30 == 0)) {
                    #ifdef WITH_THREAD
                    PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
                    #endif
                  ...
                  /* "relax/potentials/coulomb/gradient.pyx":306
 * 								drv*(
 * 									( 1/(2*alpha*alpha)+2/k_2 ) * shifts[shift][m] * \
 * 									shifts[shift][l]             # <<<<<<<<<<<<<<
 * 									)
 ...
 */
                  ...
                  /* "relax/potentials/coulomb/gradient.pyx":303
 * 						for m in range(l,3):
 * 							# deriv with respect to strain epsilon_lm
 * 							stresses[l][m] += \             # <<<<<<<<<<<<<<
 * 								drv*(
 ...
 */
                  ...
                  __pyx_t_23 = __pyx_v_m;
                  *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_stresses.data + __pyx_t_24 * __pyx_v_stresses.strides[0]) ) + __pyx_t_23 * __pyx_v_stresses.strides[1]) )) += (__pyx_v_drv * ((((1.0 / __pyx_t_30) + (2.0 / __pyx_v_k_2)) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_shifts.data + __pyx_t_28 * __pyx_v_shifts.strides[0]) ) + __pyx_t_27 * __pyx_v_shifts.strides[1]) )))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_shifts.data + __pyx_t_26 * __pyx_v_shifts.strides[0]) ) + __pyx_t_25 * __pyx_v_shifts.strides[1]) )))));

                  /* "relax/potentials/coulomb/gradient.pyx":309
 * 									)
 * 							# Add the following if alpha is not constant
 * 							if (l==m):             # <<<<<<<<<<<<<<
 * 								stresses[l][m] -= \
 ...
 */
                  ...
                  if (__pyx_t_5) {
                    ...
                    /* "relax/potentials/coulomb/gradient.pyx":312
 * 								stresses[l][m] -= \
 * 									drv*(1 - \
 ...
 * 		# Deallocate distance vector
 */
                    __pyx_t_30 = (2.0 * pow(__pyx_v_alpha, 3.0));
                    if (unlikely(__pyx_t_30 == 0)) {
                      #ifdef WITH_THREAD
                      PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
                      #endif
                    ...
                    /* "relax/potentials/coulomb/gradient.pyx":310
 * 							# Add the following if alpha is not constant
 * 							if (l==m):
 * 								stresses[l][m] -= \             # <<<<<<<<<<<<<<
 * 									drv*(1 - \
 ...
 */
                    ...
                    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_stresses.data + __pyx_t_25 * __pyx_v_stresses.strides[0]) ) + __pyx_t_26 * __pyx_v_stresses.strides[1]) )) -= (__pyx_v_drv * (1.0 - ((__pyx_v_k_2 / __pyx_t_30) * __pyx_v_alpha_drv)));
 ...
 */
        ...
        /* "relax/potentials/coulomb/gradient.pyx":315
 * 
 * 		# Deallocate distance vector
 * 		free(rij)             # <<<<<<<<<<<<<<
 * 		rij = NULL
 ...
 */
        ...
        /* "relax/potentials/coulomb/gradient.pyx":316
 * 		# Deallocate distance vector
 * 		free(rij)
 * 		rij = NULL             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "relax/potentials/coulomb/gradient.pyx":318
 * 		rij = NULL
 * 
 * 	return grad             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("relax.potentials.coulomb.gradient.recip_drv", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
...
/* "relax/potentials/coulomb/gradient.pyx":321
 * 
 * 
...
static __Pyx_memviewslice __pyx_f_5relax_10potentials_7coulomb_8gradient_fill_stresses(__Pyx_memviewslice __pyx_v_grad, __Pyx_memviewslice __pyx_v_stresses, struct __pyx_opt_args_5relax_10potentials_7coulomb_8gradient_fill_stresses *__pyx_optional_args) {
  double __pyx_v_volume = ((double)1.0);
  Py_ssize_t __pyx_v_i;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("fill_stresses", 0);
  if (__pyx_optional_args) {
    if (__pyx_optional_args->__pyx_n > 0) {
      __pyx_v_volume = __pyx_optional_args->volume;
    }
  }

  /* "relax/potentials/coulomb/gradient.pyx":337
 * 	"""
 * 	cdef Py_ssize_t i, j
 * 	for i in range(3):             # <<<<<<<<<<<<<<
 ...
 */
  for (__pyx_t_1 = 0; __pyx_t_1 < 3; __pyx_t_1+=1) {
    ...
    /* "relax/potentials/coulomb/gradient.pyx":338
 * 	cdef Py_ssize_t i, j
 * 	for i in range(3):
 * 		for j in range(i+1,3):             # <<<<<<<<<<<<<<
 * 			stresses[j][i] = stresses[i][j]
 * 
 */
    for (__pyx_t_2 = (__pyx_v_i + 1); __pyx_t_2 < 3; __pyx_t_2+=1) {
      __pyx_v_j = __pyx_t_2;

      /* "relax/potentials/coulomb/gradient.pyx":339
 * 	for i in range(3):
 * 		for j in range(i+1,3):
 * 			stresses[j][i] = stresses[i][j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_5 = -1;
      if (__pyx_t_3 < 0) {
        __pyx_t_3 += __pyx_v_stresses.shape[0];
        if (unlikely(__pyx_t_3 < 0)) __pyx_t_5 = 0;
      } else if (unlikely(__pyx_t_3 >= __pyx_v_stresses.shape[0])) __pyx_t_5 = 0;
      if (__pyx_t_4 < 0) {
        __pyx_t_4 += __pyx_v_stresses.shape[1];
        if (unlikely(__pyx_t_4 < 0)) __pyx_t_5 = 1;
      } else if (unlikely(__pyx_t_4 >= __pyx_v_stresses.shape[1])) __pyx_t_5 = 1;
      ...
      __pyx_t_5 = -1;
      if (__pyx_t_6 < 0) {
        __pyx_t_6 += __pyx_v_stresses.shape[0];
        if (unlikely(__pyx_t_6 < 0)) __pyx_t_5 = 0;
      } else if (unlikely(__pyx_t_6 >= __pyx_v_stresses.shape[0])) __pyx_t_5 = 0;
      if (__pyx_t_7 < 0) {
        __pyx_t_7 += __pyx_v_stresses.shape[1];
        if (unlikely(__pyx_t_7 < 0)) __pyx_t_5 = 1;
      } else if (unlikely(__pyx_t_7 >= __pyx_v_stresses.shape[1])) __pyx_t_5 = 1;
      if (unlikely(__pyx_t_5 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_5);
        __PYX_ERR(0, 339, __pyx_L1_error)
      }
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_stresses.data + __pyx_t_6 * __pyx_v_stresses.strides[0]) ) + __pyx_t_7 * __pyx_v_stresses.strides[1]) )) = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_stresses.data + __pyx_t_3 * __pyx_v_stresses.strides[0]) ) + __pyx_t_4 * __pyx_v_stresses.strides[1]) )));
    }
  }

  /* "relax/potentials/coulomb/gradient.pyx":341
 * 			stresses[j][i] = stresses[i][j]
 * 
 * 	for i in range(-1,-4,-1):             # <<<<<<<<<<<<<<
 ...
 */
  for (__pyx_t_1 = -1L; __pyx_t_1 > -4L; __pyx_t_1-=1) {
    __pyx_v_i = __pyx_t_1;

    /* "relax/potentials/coulomb/gradient.pyx":342
 * 
 * 	for i in range(-1,-4,-1):
 * 		for j in range(-1,i-1,-1):             # <<<<<<<<<<<<<<
 * 			grad[i][j] = stresses[i][j]/volume
 ...
 */
    ...
    __pyx_t_8 = __pyx_t_2;
    for (__pyx_t_9 = -1L; __pyx_t_9 > __pyx_t_8; __pyx_t_9-=1) {
      __pyx_v_j = __pyx_t_9;

      /* "relax/potentials/coulomb/gradient.pyx":343
 * 	for i in range(-1,-4,-1):
 * 		for j in range(-1,i-1,-1):
 * 			grad[i][j] = stresses[i][j]/volume             # <<<<<<<<<<<<<<
 * 			grad[j][i] = stresses[i][j]/volume
 ...
 */
      ...
      __pyx_t_5 = -1;
      if (__pyx_t_4 < 0) {
        __pyx_t_4 += __pyx_v_stresses.shape[0];
        if (unlikely(__pyx_t_4 < 0)) __pyx_t_5 = 0;
      } else if (unlikely(__pyx_t_4 >= __pyx_v_stresses.shape[0])) __pyx_t_5 = 0;
      if (__pyx_t_3 < 0) {
        __pyx_t_3 += __pyx_v_stresses.shape[1];
        if (unlikely(__pyx_t_3 < 0)) __pyx_t_5 = 1;
      } else if (unlikely(__pyx_t_3 >= __pyx_v_stresses.shape[1])) __pyx_t_5 = 1;
      if (unlikely(__pyx_t_5 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_5);
        __PYX_ERR(0, 343, __pyx_L1_error)
      }
      __pyx_t_10 = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_stresses.data + __pyx_t_4 * __pyx_v_stresses.strides[0]) ) + __pyx_t_3 * __pyx_v_stresses.strides[1]) )));
      if (unlikely(__pyx_v_volume == 0)) {
        PyErr_SetString(PyExc_ZeroDivisionError, "float division");
        __PYX_ERR(0, 343, __pyx_L1_error)
      }
      ...
      __pyx_t_5 = -1;
      if (__pyx_t_3 < 0) {
        __pyx_t_3 += __pyx_v_grad.shape[0];
        if (unlikely(__pyx_t_3 < 0)) __pyx_t_5 = 0;
      } else if (unlikely(__pyx_t_3 >= __pyx_v_grad.shape[0])) __pyx_t_5 = 0;
      if (__pyx_t_4 < 0) {
        __pyx_t_4 += __pyx_v_grad.shape[1];
        if (unlikely(__pyx_t_4 < 0)) __pyx_t_5 = 1;
      } else if (unlikely(__pyx_t_4 >= __pyx_v_grad.shape[1])) __pyx_t_5 = 1;
      if (unlikely(__pyx_t_5 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_5);
        __PYX_ERR(0, 343, __pyx_L1_error)
      }
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grad.data + __pyx_t_3 * __pyx_v_grad.strides[0]) ) + __pyx_t_4 * __pyx_v_grad.strides[1]) )) = (__pyx_t_10 / __pyx_v_volume);

      /* "relax/potentials/coulomb/gradient.pyx":344
 * 		for j in range(-1,i-1,-1):
 * 			grad[i][j] = stresses[i][j]/volume
 * 			grad[j][i] = stresses[i][j]/volume             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "relax/potentials/coulomb/gradient.pyx":346
 * 			grad[j][i] = stresses[i][j]/volume
 * 
 * 	return stresses             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("relax.potentials.coulomb.gradient.fill_stresses", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "relax.potentials.coulomb.gradient.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "relax.potentials.coulomb.gradient.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "relax.potentials.coulomb.gradient.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "relax.potentials.coulomb.gradient._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_gradient(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_gradient},
  {0, NULL}
};
#endif
 ...
 * 	cdef double dist
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_u_Points_are_not_3_dimensional); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 112, __pyx_L1_error)
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("self_drv", (void (*)(void))__pyx_f_5relax_10potentials_7coulomb_8gradient_self_drv, "__Pyx_memviewslice (__Pyx_memviewslice, __Pyx_memviewslice, double, double, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("real_drv", (void (*)(void))__pyx_f_5relax_10potentials_7coulomb_8gradient_real_drv, "__Pyx_memviewslice (__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double, double, double, double, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("erfc_drv", (void (*)(void))__pyx_f_5relax_10potentials_7coulomb_8gradient_erfc_drv, "double (double, int, double)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("recip_drv", (void (*)(void))__pyx_f_5relax_10potentials_7coulomb_8gradient_recip_drv, "__Pyx_memviewslice (__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double, double, double, double, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("fill_stresses", (void (*)(void))__pyx_f_5relax_10potentials_7coulomb_8gradient_fill_stresses, "__Pyx_memviewslice (__Pyx_memviewslice, __Pyx_memviewslice, struct __pyx_opt_args_5relax_10potentials_7coulomb_8gradient_fill_stresses *__pyx_optional_args)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initgradient(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initgradient(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_gradient(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_gradient(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_gradient(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'gradient' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_gradient(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("gradient", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_relax__potentials__coulomb__gradient) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "relax.potentials.coulomb.gradient")) {
      if (unlikely(PyDict_SetItemString(modules, "relax.potentials.coulomb.gradient", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "relax/potentials/coulomb/gradient.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "relax/potentials/coulomb/gradient.pyx":3
 * import numpy as np
 * cimport numpy as cnp
 * import warnings             # <<<<<<<<<<<<<<
 * import heapq
 ...
 */
  ...
  /* "relax/potentials/coulomb/gradient.pyx":4
 * cimport numpy as cnp
 * import warnings
 * import heapq             # <<<<<<<<<<<<<<
 * import csv
 ...
 */
  ...
  /* "relax/potentials/coulomb/gradient.pyx":5
 * import warnings
 * import heapq
 * import csv             # <<<<<<<<<<<<<<
 * import sys
 ...
 */
  ...
  /* "relax/potentials/coulomb/gradient.pyx":6
 * import heapq
 * import csv
 * import sys             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "relax/potentials/coulomb/gradient.pyx":19
 ...
 */
  ...
  /* "relax/potentials/coulomb/gradient.pyx":28
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init relax.potentials.coulomb.gradient", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init relax.potentials.coulomb.gradient");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
