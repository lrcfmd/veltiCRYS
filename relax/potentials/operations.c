...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "relax.potentials.operations",
        "sources": [
            "relax/potentials/operations.pyx"
        ]
    },
    "module_name": "relax.potentials.operations"
}
END: Cython Metadata */
...
#define __PYX_HAVE__relax__potentials__operations
#define __PYX_HAVE_API__relax__potentials__operations
/* Early includes */
#include <math.h>
#include <string.h>
#include <stdio.h>
...
static __Pyx_memviewslice __pyx_f_5relax_10potentials_10operations_get_all_distances(__Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
static __Pyx_memviewslice __pyx_f_5relax_10potentials_10operations_get_min_dist(__Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "relax.potentials.operations"
extern int __pyx_module_is_main_relax__potentials__operations;
int __pyx_module_is_main_relax__potentials__operations = 0;

/* Implementation of 'relax.potentials.operations' */
...
static const char __pyx_k_Error_in_vectors_dimensions[] = "Error in vectors' dimensions.";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_Error_in_matrices_dimensions[] = "Error in matrices' dimensions.";
static const char __pyx_k_Error_in_matrix_s_dimensions[] = "Error in matrix's dimensions.";
...
static PyObject *__pyx_kp_u_Error_in_matrices_dimensions;
static PyObject *__pyx_kp_u_Error_in_matrix_s_dimensions;
static PyObject *__pyx_kp_u_Error_in_vectors_dimensions;
...
static PyObject *__pyx_pf_5relax_10potentials_10operations_get_all_distances(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_pos, int __pyx_v_N); /* proto */
static PyObject *__pyx_pf_5relax_10potentials_10operations_2get_min_dist(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_pos, int __pyx_v_N); /* proto */
...
/* "relax/potentials/operations.pyx":10
...
static double __pyx_f_5relax_10potentials_10operations_dot_vv(__Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b) {
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("dot_vv", 0);

  /* "relax/potentials/operations.pyx":14
 * 
 *     """
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":15
 *     """
 *     cdef Py_ssize_t M = a.shape[0]
 *     cdef Py_ssize_t N = b.shape[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":17
 *     cdef Py_ssize_t N = b.shape[0]
 * 
 *     if not M==N:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "relax/potentials/operations.pyx":18
 * 
 *     if not M==N:
 *         raise ValueError("Error in vectors' dimensions.")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":20
 *         raise ValueError("Error in vectors' dimensions.")
 * 
 *     cdef double result = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":22
 *     cdef double result = 0
 * 
 *     for k in range(M):             # <<<<<<<<<<<<<<
 *         result += a[k]*b[k]
 ...
 */
  ...
  for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
    ...
    /* "relax/potentials/operations.pyx":23
 * 
 *     for k in range(M):
 *         result += a[k]*b[k]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_6 = __pyx_v_k;
    __pyx_t_7 = __pyx_v_k;
    __pyx_v_result = (__pyx_v_result + ((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_6 * __pyx_v_a.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_7 * __pyx_v_b.strides[0]) )))));
  }

  /* "relax/potentials/operations.pyx":25
 *         result += a[k]*b[k]
 * 
 *     return result             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("relax.potentials.operations.dot_vv", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0.0;
  __pyx_L0:;
...
/* "relax/potentials/operations.pyx":30
 * @cython.boundscheck(False)  # turn off bounds-checking
 * @cython.wraparound(False)  # turn off negative index wrapping
...
static __Pyx_memviewslice __pyx_f_5relax_10potentials_10operations_dot_vm(__Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_B) {
  Py_ssize_t __pyx_v_M;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("dot_vm", 0);

  /* "relax/potentials/operations.pyx":35
 * 
 *     """
 *     cdef Py_ssize_t M = a.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":36
 *     """
 *     cdef Py_ssize_t M = a.shape[0]
 *     cdef Py_ssize_t Nb = B.shape[0]             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t K = B.shape[1]
 * 
 */
  __pyx_v_Nb = (__pyx_v_B.shape[0]);

  /* "relax/potentials/operations.pyx":37
 *     cdef Py_ssize_t M = a.shape[0]
 *     cdef Py_ssize_t Nb = B.shape[0]
 *     cdef Py_ssize_t K = B.shape[1]             # <<<<<<<<<<<<<<
 * 
 *     if not M==Nb:
 */
  __pyx_v_K = (__pyx_v_B.shape[1]);

  /* "relax/potentials/operations.pyx":39
 *     cdef Py_ssize_t K = B.shape[1]
 * 
 *     if not M==Nb:             # <<<<<<<<<<<<<<
 *         raise ValueError("Error in vectors' dimensions.")
 * 
 */
  __pyx_t_1 = ((!((__pyx_v_M == __pyx_v_Nb) != 0)) != 0);
  if (unlikely(__pyx_t_1)) {

    /* "relax/potentials/operations.pyx":40
 * 
 *     if not M==Nb:
 *         raise ValueError("Error in vectors' dimensions.")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":45
 *     cdef double t
 * 
 ...
 */
  ...
  __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_shape, __pyx_t_4) < 0) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyInt_FromSize_t((sizeof(double))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_itemsize, __pyx_t_4) < 0) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_format, __pyx_n_u_d) < 0) __PYX_ERR(0, 45, __pyx_L1_error)
  __pyx_t_4 = __Pyx_PyObject_Call(((PyObject *)__pyx_array_type), __pyx_empty_tuple, __pyx_t_2); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_4, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_result = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "relax/potentials/operations.pyx":47
 *     result = cvarray(shape=(K,), itemsize=sizeof(double), format="d")
 * 
 *     for k in range(K):             # <<<<<<<<<<<<<<
 *         t = 0
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "relax/potentials/operations.pyx":48
 * 
 *     for k in range(K):
 *         t = 0             # <<<<<<<<<<<<<<
 *         for n in range(M):
 ...
 */
    ...
    /* "relax/potentials/operations.pyx":49
 *     for k in range(K):
 *         t = 0
 *         for n in range(M):             # <<<<<<<<<<<<<<
 *             t += a[n] * B[n, k]
 ...
 */
    ...
    for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
      ...
      /* "relax/potentials/operations.pyx":50
 *         t = 0
 *         for n in range(M):
 *             t += a[n] * B[n, k]             # <<<<<<<<<<<<<<
 *         result[k] = t
 ...
 */
      ...
      __pyx_v_t = (__pyx_v_t + ((*((double *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_12 * __pyx_v_a.strides[0]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_B.data + __pyx_t_13 * __pyx_v_B.strides[0]) ) + __pyx_t_14 * __pyx_v_B.strides[1]) )))));
    }

    /* "relax/potentials/operations.pyx":51
 *         for n in range(M):
 *             t += a[n] * B[n, k]
 *         result[k] = t             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_14 = __pyx_v_k;
    *((double *) ( /* dim=0 */ (__pyx_v_result.data + __pyx_t_14 * __pyx_v_result.strides[0]) )) = __pyx_v_t;
  }

  /* "relax/potentials/operations.pyx":53
 *         result[k] = t
 * 
 *     return result             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("relax.potentials.operations.dot_vm", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
...
/* "relax/potentials/operations.pyx":58
...
static __Pyx_memviewslice __pyx_f_5relax_10potentials_10operations_dot_mm(__Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_B) {
  Py_ssize_t __pyx_v_M;
  ...
  /* "relax/potentials/operations.pyx":62
 * 
 *     """
 *     cdef Py_ssize_t M = A.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":63
 *     """
 *     cdef Py_ssize_t M = A.shape[0]
 *     cdef Py_ssize_t Na = A.shape[1]             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t Nb = B.shape[0]
 *     cdef Py_ssize_t K = B.shape[1]
 */
  __pyx_v_Na = (__pyx_v_A.shape[1]);

  /* "relax/potentials/operations.pyx":64
 *     cdef Py_ssize_t M = A.shape[0]
 *     cdef Py_ssize_t Na = A.shape[1]
 *     cdef Py_ssize_t Nb = B.shape[0]             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t K = B.shape[1]
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":65
 *     cdef Py_ssize_t Na = A.shape[1]
 *     cdef Py_ssize_t Nb = B.shape[0]
 *     cdef Py_ssize_t K = B.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":67
 *     cdef Py_ssize_t K = B.shape[1]
 * 
 *     if not Na==Nb:             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_1 = ((!((__pyx_v_Na == __pyx_v_Nb) != 0)) != 0);
  if (unlikely(__pyx_t_1)) {

    /* "relax/potentials/operations.pyx":68
 * 
 *     if not Na==Nb:
 *         raise ValueError("Error in matrices' dimensions.")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":73
 *     cdef double t
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyInt_FromSsize_t(__pyx_v_M); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = PyInt_FromSsize_t(__pyx_v_K); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_format, __pyx_n_u_d) < 0) __PYX_ERR(0, 73, __pyx_L1_error)
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_result = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "relax/potentials/operations.pyx":75
 *     result = cvarray(shape=(M,K), itemsize=sizeof(double), format="d")
 * 
 *     for m in range(M):             # <<<<<<<<<<<<<<
 *         for k in range(K):
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "relax/potentials/operations.pyx":76
 * 
 *     for m in range(M):
 *         for k in range(K):             # <<<<<<<<<<<<<<
 *             result[m,k] = 0
 ...
 */
    ...
    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      ...
      /* "relax/potentials/operations.pyx":77
 *     for m in range(M):
 *         for k in range(K):
 *             result[m,k] = 0             # <<<<<<<<<<<<<<
 *             for n in range(Na):
 ...
 */
      ...
      __pyx_t_14 = __pyx_v_k;
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_result.data + __pyx_t_13 * __pyx_v_result.strides[0]) ) + __pyx_t_14 * __pyx_v_result.strides[1]) )) = 0.0;

      /* "relax/potentials/operations.pyx":78
 *         for k in range(K):
 *             result[m,k] = 0
 *             for n in range(Na):             # <<<<<<<<<<<<<<
 *                 result[m,k] += A[m,n] * B[n,k]
 * 
 */
      __pyx_t_15 = __pyx_v_Na;
      __pyx_t_16 = __pyx_t_15;
      for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
        __pyx_v_n = __pyx_t_17;

        /* "relax/potentials/operations.pyx":79
 *             result[m,k] = 0
 *             for n in range(Na):
 *                 result[m,k] += A[m,n] * B[n,k]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_result.data + __pyx_t_20 * __pyx_v_result.strides[0]) ) + __pyx_t_21 * __pyx_v_result.strides[1]) )) += ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_A.data + __pyx_t_14 * __pyx_v_A.strides[0]) ) + __pyx_t_13 * __pyx_v_A.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_B.data + __pyx_t_18 * __pyx_v_B.strides[0]) ) + __pyx_t_19 * __pyx_v_B.strides[1]) ))));
      }
    }
  }

  /* "relax/potentials/operations.pyx":81
 *                 result[m,k] += A[m,n] * B[n,k]
 * 
 *     return result             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("relax.potentials.operations.dot_mm", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
...
/* "relax/potentials/operations.pyx":86
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
...
static double __pyx_f_5relax_10potentials_10operations_norm(__Pyx_memviewslice __pyx_v_a) {
  ...
  /* "relax/potentials/operations.pyx":89
 * 
 *     cdef Py_ssize_t i
 *     cdef double result = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":91
 *     cdef double result = 0
 * 
 *     for i in range(a.shape[0]):             # <<<<<<<<<<<<<<
 *         result += a[i]*a[i]
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "relax/potentials/operations.pyx":92
 * 
 *     for i in range(a.shape[0]):
 *         result += a[i]*a[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":97
 *     # printf("\n%f\n",result)
 * 
 *     if result==0:             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_6 = ((__pyx_v_result == 0.0) != 0);
  if (__pyx_t_6) {

    /* "relax/potentials/operations.pyx":98
 * 
 *     if result==0:
 *         printf("\x1B[31mWarning:\033[0m Vector norm is zero.\n")             # <<<<<<<<<<<<<<
 * 
 *     return sqrt(result)
 */
    (void)(printf(((char const *)"\033[31mWarning:\033[0m Vector norm is zero.\n")));
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":100
 *         printf("\x1B[31mWarning:\033[0m Vector norm is zero.\n")
 * 
 *     return sqrt(result)             # <<<<<<<<<<<<<<
 * 
...
/* "relax/potentials/operations.pyx":105
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
...
static double __pyx_f_5relax_10potentials_10operations_norm_m(__Pyx_memviewslice __pyx_v_a) {
  Py_ssize_t __pyx_v_i;
  double __pyx_v_result;
  ...
  Py_ssize_t __pyx_t_9;
  Py_ssize_t __pyx_t_10;
  __Pyx_RefNannySetupContext("norm_m", 0);

  /* "relax/potentials/operations.pyx":108
 * 
 *     cdef Py_ssize_t i
 *     cdef double result = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":110
 *     cdef double result = 0
 * 
 *     for i in range(a.shape[0]):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "relax/potentials/operations.pyx":111
 * 
 *     for i in range(a.shape[0]):
 *         for j in range(a.shape[1]):             # <<<<<<<<<<<<<<
 *             result += a[i][j]*a[i][j]
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "relax/potentials/operations.pyx":112
 *     for i in range(a.shape[0]):
 *         for j in range(a.shape[1]):
 *             result += a[i][j]*a[i][j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_v_result = (__pyx_v_result + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_7 * __pyx_v_a.strides[0]) ) + __pyx_t_8 * __pyx_v_a.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_9 * __pyx_v_a.strides[0]) ) + __pyx_t_10 * __pyx_v_a.strides[1]) )))));
    }
  }

  /* "relax/potentials/operations.pyx":114
 *             result += a[i][j]*a[i][j]
 * 
 *     return sqrt(result)             # <<<<<<<<<<<<<<
 * 
...
/* "relax/potentials/operations.pyx":118
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
...
static double __pyx_f_5relax_10potentials_10operations_det(__Pyx_memviewslice __pyx_v_arr) {
  double __pyx_v_det;
  double __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  ...
  /* "relax/potentials/operations.pyx":122
 * 
 *     """
 ...
 * 
 */
  __pyx_t_2 = ((!(((__pyx_v_arr.shape[0]) == 3) != 0)) != 0);
  if (!__pyx_t_2) {
  } else {
    __pyx_t_1 = __pyx_t_2;
    goto __pyx_L4_bool_binop_done;
  }
  __pyx_t_2 = ((!(((__pyx_v_arr.shape[1]) == 3) != 0)) != 0);
  __pyx_t_1 = __pyx_t_2;
  __pyx_L4_bool_binop_done:;
  if (unlikely(__pyx_t_1)) {

    /* "relax/potentials/operations.pyx":123
 *     """
 *     if (not arr.shape[0]==3) or (not arr.shape[1]==3):
 *         raise ValueError("Error in matrix's dimensions.")             # <<<<<<<<<<<<<<
 * 
 *     cdef double det
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__3, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 123, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":126
 * 
 *     cdef double det
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":127
 *     cdef double det
 *     det = arr[0,0]*(arr[1,1]*arr[2,2]-arr[1,2]*arr[2,1])- \
 *             arr[0,1]*(arr[1,0]*arr[2,2]-arr[1,2]*arr[2,0])+ \             # <<<<<<<<<<<<<<
 *             arr[0,2]*(arr[1,0]*arr[2,1]-arr[1,1]*arr[2,0])
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":128
 *     det = arr[0,0]*(arr[1,1]*arr[2,2]-arr[1,2]*arr[2,1])- \
 *             arr[0,1]*(arr[1,0]*arr[2,2]-arr[1,2]*arr[2,0])+ \
 *             arr[0,2]*(arr[1,0]*arr[2,1]-arr[1,1]*arr[2,0])             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
  __pyx_v_det = ((((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_4 * __pyx_v_arr.strides[0]) ) + __pyx_t_5 * __pyx_v_arr.strides[1]) ))) * (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_6 * __pyx_v_arr.strides[0]) ) + __pyx_t_7 * __pyx_v_arr.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_8 * __pyx_v_arr.strides[0]) ) + __pyx_t_9 * __pyx_v_arr.strides[1]) )))) - ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_10 * __pyx_v_arr.strides[0]) ) + __pyx_t_11 * __pyx_v_arr.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_12 * __pyx_v_arr.strides[0]) ) + __pyx_t_13 * __pyx_v_arr.strides[1]) )))))) - ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_14 * __pyx_v_arr.strides[0]) ) + __pyx_t_15 * __pyx_v_arr.strides[1]) ))) * (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_16 * __pyx_v_arr.strides[0]) ) + __pyx_t_17 * __pyx_v_arr.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_18 * __pyx_v_arr.strides[0]) ) + __pyx_t_19 * __pyx_v_arr.strides[1]) )))) - ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_20 * __pyx_v_arr.strides[0]) ) + __pyx_t_21 * __pyx_v_arr.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_22 * __pyx_v_arr.strides[0]) ) + __pyx_t_23 * __pyx_v_arr.strides[1]) ))))))) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_24 * __pyx_v_arr.strides[0]) ) + __pyx_t_25 * __pyx_v_arr.strides[1]) ))) * (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_26 * __pyx_v_arr.strides[0]) ) + __pyx_t_27 * __pyx_v_arr.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_28 * __pyx_v_arr.strides[0]) ) + __pyx_t_29 * __pyx_v_arr.strides[1]) )))) - ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_30 * __pyx_v_arr.strides[0]) ) + __pyx_t_31 * __pyx_v_arr.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_32 * __pyx_v_arr.strides[0]) ) + __pyx_t_33 * __pyx_v_arr.strides[1]) )))))));

  /* "relax/potentials/operations.pyx":130
 *             arr[0,2]*(arr[1,0]*arr[2,1]-arr[1,1]*arr[2,0])
 * 
 *     return det             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_AddTraceback("relax.potentials.operations.det", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1.0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* "relax/potentials/operations.pyx":135
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
...
static double __pyx_f_5relax_10potentials_10operations_get_real_distance(__Pyx_memviewslice __pyx_v_ioni, __Pyx_memviewslice __pyx_v_ionj, __Pyx_memviewslice __pyx_v_shift) {
  double __pyx_v_dist;
  double __pyx_r;
  Py_ssize_t __pyx_t_1;
  Py_ssize_t __pyx_t_2;
  ...
  /* "relax/potentials/operations.pyx":137
 * cdef double get_real_distance(double[:] ioni, double[:] ionj, double[:] shift) nogil:
 *     cdef double dist
 *     dist = (ioni[0]+shift[0]-ionj[0])*(ioni[0]+shift[0]-ionj[0])+ \             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":138
 *     cdef double dist
 *     dist = (ioni[0]+shift[0]-ionj[0])*(ioni[0]+shift[0]-ionj[0])+ \
 *             (ioni[1]+shift[1]-ionj[1])*(ioni[1]+shift[1]-ionj[1])+ \             # <<<<<<<<<<<<<<
 *             (ioni[2]+shift[2]-ionj[2])*(ioni[2]+shift[2]-ionj[2])
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":139
 *     dist = (ioni[0]+shift[0]-ionj[0])*(ioni[0]+shift[0]-ionj[0])+ \
 *             (ioni[1]+shift[1]-ionj[1])*(ioni[1]+shift[1]-ionj[1])+ \
 *             (ioni[2]+shift[2]-ionj[2])*(ioni[2]+shift[2]-ionj[2])             # <<<<<<<<<<<<<<
 *     dist = sqrt(dist)
 ...
 *     dist = sqrt(dist)
 */
  __pyx_v_dist = ((((((*((double *) ( /* dim=0 */ (__pyx_v_ioni.data + __pyx_t_1 * __pyx_v_ioni.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_shift.data + __pyx_t_2 * __pyx_v_shift.strides[0]) )))) - (*((double *) ( /* dim=0 */ (__pyx_v_ionj.data + __pyx_t_3 * __pyx_v_ionj.strides[0]) )))) * (((*((double *) ( /* dim=0 */ (__pyx_v_ioni.data + __pyx_t_4 * __pyx_v_ioni.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_shift.data + __pyx_t_5 * __pyx_v_shift.strides[0]) )))) - (*((double *) ( /* dim=0 */ (__pyx_v_ionj.data + __pyx_t_6 * __pyx_v_ionj.strides[0]) ))))) + ((((*((double *) ( /* dim=0 */ (__pyx_v_ioni.data + __pyx_t_7 * __pyx_v_ioni.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_shift.data + __pyx_t_8 * __pyx_v_shift.strides[0]) )))) - (*((double *) ( /* dim=0 */ (__pyx_v_ionj.data + __pyx_t_9 * __pyx_v_ionj.strides[0]) )))) * (((*((double *) ( /* dim=0 */ (__pyx_v_ioni.data + __pyx_t_10 * __pyx_v_ioni.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_shift.data + __pyx_t_11 * __pyx_v_shift.strides[0]) )))) - (*((double *) ( /* dim=0 */ (__pyx_v_ionj.data + __pyx_t_12 * __pyx_v_ionj.strides[0]) )))))) + ((((*((double *) ( /* dim=0 */ (__pyx_v_ioni.data + __pyx_t_13 * __pyx_v_ioni.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_shift.data + __pyx_t_14 * __pyx_v_shift.strides[0]) )))) - (*((double *) ( /* dim=0 */ (__pyx_v_ionj.data + __pyx_t_15 * __pyx_v_ionj.strides[0]) )))) * (((*((double *) ( /* dim=0 */ (__pyx_v_ioni.data + __pyx_t_16 * __pyx_v_ioni.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_shift.data + __pyx_t_17 * __pyx_v_shift.strides[0]) )))) - (*((double *) ( /* dim=0 */ (__pyx_v_ionj.data + __pyx_t_18 * __pyx_v_ionj.strides[0]) ))))));

  /* "relax/potentials/operations.pyx":140
 *             (ioni[1]+shift[1]-ionj[1])*(ioni[1]+shift[1]-ionj[1])+ \
 *             (ioni[2]+shift[2]-ionj[2])*(ioni[2]+shift[2]-ionj[2])
 *     dist = sqrt(dist)             # <<<<<<<<<<<<<<
 *     return dist
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":141
 *             (ioni[2]+shift[2]-ionj[2])*(ioni[2]+shift[2]-ionj[2])
 *     dist = sqrt(dist)
 *     return dist             # <<<<<<<<<<<<<<
 * 
...
/* "relax/potentials/operations.pyx":146
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
...
static double __pyx_f_5relax_10potentials_10operations_get_recip_distance(double *__pyx_v_rij, __Pyx_memviewslice __pyx_v_shift) {
  double __pyx_v_krij;
  double __pyx_r;
  Py_ssize_t __pyx_t_1;
  Py_ssize_t __pyx_t_2;
  ...
  /* "relax/potentials/operations.pyx":149
 *     cdef double krij
 *     # dot product to find image
 ...
 */
  ...
  __pyx_t_2 = 1;
  __pyx_t_3 = 2;
  __pyx_v_krij = ((((*((double *) ( /* dim=0 */ (__pyx_v_shift.data + __pyx_t_1 * __pyx_v_shift.strides[0]) ))) * (__pyx_v_rij[0])) + ((*((double *) ( /* dim=0 */ (__pyx_v_shift.data + __pyx_t_2 * __pyx_v_shift.strides[0]) ))) * (__pyx_v_rij[1]))) + ((*((double *) ( /* dim=0 */ (__pyx_v_shift.data + __pyx_t_3 * __pyx_v_shift.strides[0]) ))) * (__pyx_v_rij[2])));

  /* "relax/potentials/operations.pyx":150
 *     # dot product to find image
 *     krij = shift[0]*rij[0] + shift[1]*rij[1] + shift[2]*rij[2]
 *     return krij             # <<<<<<<<<<<<<<
 * 
...
/* "relax/potentials/operations.pyx":155
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
...
static double *__pyx_f_5relax_10potentials_10operations_get_distance_vector(double *__pyx_v_rij, __Pyx_memviewslice __pyx_v_ioni, __Pyx_memviewslice __pyx_v_ionj, __Pyx_memviewslice __pyx_v_shift) {
  double *__pyx_r;
  Py_ssize_t __pyx_t_1;
  Py_ssize_t __pyx_t_2;
  Py_ssize_t __pyx_t_3;

  /* "relax/potentials/operations.pyx":156
 * @cython.wraparound(False)
 * cdef double* get_distance_vector(double* rij, double[:] ioni, double[:] ionj, double[:] shift) nogil:
 *     rij[0] = ioni[0]+shift[0]-ionj[0] # distance vector             # <<<<<<<<<<<<<<
 *     rij[1] = ioni[1]+shift[1]-ionj[1]
 ...
 */
  ...
  __pyx_t_2 = 0;
  __pyx_t_3 = 0;
  (__pyx_v_rij[0]) = (((*((double *) ( /* dim=0 */ (__pyx_v_ioni.data + __pyx_t_1 * __pyx_v_ioni.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_shift.data + __pyx_t_2 * __pyx_v_shift.strides[0]) )))) - (*((double *) ( /* dim=0 */ (__pyx_v_ionj.data + __pyx_t_3 * __pyx_v_ionj.strides[0]) ))));

  /* "relax/potentials/operations.pyx":157
 * cdef double* get_distance_vector(double* rij, double[:] ioni, double[:] ionj, double[:] shift) nogil:
 *     rij[0] = ioni[0]+shift[0]-ionj[0] # distance vector
 *     rij[1] = ioni[1]+shift[1]-ionj[1]             # <<<<<<<<<<<<<<
 *     rij[2] = ioni[2]+shift[2]-ionj[2]
 ...
 */
  ...
  __pyx_t_2 = 1;
  __pyx_t_1 = 1;
  (__pyx_v_rij[1]) = (((*((double *) ( /* dim=0 */ (__pyx_v_ioni.data + __pyx_t_3 * __pyx_v_ioni.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_shift.data + __pyx_t_2 * __pyx_v_shift.strides[0]) )))) - (*((double *) ( /* dim=0 */ (__pyx_v_ionj.data + __pyx_t_1 * __pyx_v_ionj.strides[0]) ))));

  /* "relax/potentials/operations.pyx":158
 *     rij[0] = ioni[0]+shift[0]-ionj[0] # distance vector
 *     rij[1] = ioni[1]+shift[1]-ionj[1]
 *     rij[2] = ioni[2]+shift[2]-ionj[2]             # <<<<<<<<<<<<<<
 *     return rij
 ...
 */
  ...
  __pyx_t_2 = 2;
  __pyx_t_3 = 2;
  (__pyx_v_rij[2]) = (((*((double *) ( /* dim=0 */ (__pyx_v_ioni.data + __pyx_t_1 * __pyx_v_ioni.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_shift.data + __pyx_t_2 * __pyx_v_shift.strides[0]) )))) - (*((double *) ( /* dim=0 */ (__pyx_v_ionj.data + __pyx_t_3 * __pyx_v_ionj.strides[0]) ))));

  /* "relax/potentials/operations.pyx":159
 *     rij[1] = ioni[1]+shift[1]-ionj[1]
 *     rij[2] = ioni[2]+shift[2]-ionj[2]
 *     return rij             # <<<<<<<<<<<<<<
 * 
...
/* "relax/potentials/operations.pyx":162
 * 
 * 
...
static PyObject *__pyx_pw_5relax_10potentials_10operations_1get_all_distances(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_5relax_10potentials_10operations_get_all_distances(__Pyx_memviewslice __pyx_v_pos, int __pyx_v_N, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("get_all_distances", 0);

  /* "relax/potentials/operations.pyx":167
 ...
 */
  ...
  __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_7cpython_5array_array), __pyx_t_2, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 167, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_3 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_3.memview)) __PYX_ERR(0, 167, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_nil_array = __pyx_t_3;
  __pyx_t_3.memview = NULL;
  __pyx_t_3.data = NULL;

  /* "relax/potentials/operations.pyx":168
 * 
 *     nil_array = array("d",[0,0,0])
 *     dists = cvarray(shape=(N,N), itemsize=sizeof(double), format="d")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_N); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 168, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __pyx_t_2 = 0;
  __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_shape, __pyx_t_5) < 0) __PYX_ERR(0, 168, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyInt_FromSize_t((sizeof(double))); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 168, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_itemsize, __pyx_t_5) < 0) __PYX_ERR(0, 168, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_format, __pyx_n_u_d) < 0) __PYX_ERR(0, 168, __pyx_L1_error)
  __pyx_t_5 = __Pyx_PyObject_Call(((PyObject *)__pyx_array_type), __pyx_empty_tuple, __pyx_t_1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 168, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 168, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_dists = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "relax/potentials/operations.pyx":170
 *     dists = cvarray(shape=(N,N), itemsize=sizeof(double), format="d")
 * 
 *     for ioni in range(N):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "relax/potentials/operations.pyx":171
 * 
 *     for ioni in range(N):
 *         for ionj in range(ioni, N):             # <<<<<<<<<<<<<<
 *             dists[ioni][ionj] = get_real_distance(pos[ioni], pos[ionj], nil_array)
 ...
 */
    ...
    __pyx_t_11 = __pyx_t_10;
    for (__pyx_t_12 = __pyx_v_ioni; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      __pyx_v_ionj = __pyx_t_12;

      /* "relax/potentials/operations.pyx":172
 *     for ioni in range(N):
 *         for ionj in range(ioni, N):
 *             dists[ioni][ionj] = get_real_distance(pos[ioni], pos[ionj], nil_array)             # <<<<<<<<<<<<<<
 *             dists[ionj][ioni] = dists[ioni][ionj]
...
__pyx_t_14 = __pyx_v_ioni;
      __pyx_t_15 = __pyx_v_ionj;
      __pyx_t_16 = -1;
      if (__pyx_t_14 < 0) {
        __pyx_t_14 += __pyx_v_dists.shape[0];
        if (unlikely(__pyx_t_14 < 0)) __pyx_t_16 = 0;
      } else if (unlikely(__pyx_t_14 >= __pyx_v_dists.shape[0])) __pyx_t_16 = 0;
      if (__pyx_t_15 < 0) {
        __pyx_t_15 += __pyx_v_dists.shape[1];
        if (unlikely(__pyx_t_15 < 0)) __pyx_t_16 = 1;
      } else if (unlikely(__pyx_t_15 >= __pyx_v_dists.shape[1])) __pyx_t_16 = 1;
      if (unlikely(__pyx_t_16 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_16);
        __PYX_ERR(0, 172, __pyx_L1_error)
      }
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_dists.data + __pyx_t_14 * __pyx_v_dists.strides[0]) ) + __pyx_t_15 * __pyx_v_dists.strides[1]) )) = __pyx_f_5relax_10potentials_10operations_get_real_distance(__pyx_t_3, __pyx_t_13, __pyx_v_nil_array);
      ...
      /* "relax/potentials/operations.pyx":173
 *         for ionj in range(ioni, N):
 *             dists[ioni][ionj] = get_real_distance(pos[ioni], pos[ionj], nil_array)
 *             dists[ionj][ioni] = dists[ioni][ionj]             # <<<<<<<<<<<<<<
 *     return dists
 ...
 */
      ...
      __pyx_t_16 = -1;
      if (__pyx_t_15 < 0) {
        __pyx_t_15 += __pyx_v_dists.shape[0];
        if (unlikely(__pyx_t_15 < 0)) __pyx_t_16 = 0;
      } else if (unlikely(__pyx_t_15 >= __pyx_v_dists.shape[0])) __pyx_t_16 = 0;
      if (__pyx_t_14 < 0) {
        __pyx_t_14 += __pyx_v_dists.shape[1];
        if (unlikely(__pyx_t_14 < 0)) __pyx_t_16 = 1;
      } else if (unlikely(__pyx_t_14 >= __pyx_v_dists.shape[1])) __pyx_t_16 = 1;
      if (unlikely(__pyx_t_16 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_16);
      ...
      __pyx_t_16 = -1;
      if (__pyx_t_17 < 0) {
        __pyx_t_17 += __pyx_v_dists.shape[0];
        if (unlikely(__pyx_t_17 < 0)) __pyx_t_16 = 0;
      } else if (unlikely(__pyx_t_17 >= __pyx_v_dists.shape[0])) __pyx_t_16 = 0;
      if (__pyx_t_18 < 0) {
        __pyx_t_18 += __pyx_v_dists.shape[1];
        if (unlikely(__pyx_t_18 < 0)) __pyx_t_16 = 1;
      } else if (unlikely(__pyx_t_18 >= __pyx_v_dists.shape[1])) __pyx_t_16 = 1;
      if (unlikely(__pyx_t_16 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_16);
        __PYX_ERR(0, 173, __pyx_L1_error)
      }
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_dists.data + __pyx_t_17 * __pyx_v_dists.strides[0]) ) + __pyx_t_18 * __pyx_v_dists.strides[1]) )) = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_dists.data + __pyx_t_15 * __pyx_v_dists.strides[0]) ) + __pyx_t_14 * __pyx_v_dists.strides[1]) )));
    }
  }

  /* "relax/potentials/operations.pyx":174
 *             dists[ioni][ionj] = get_real_distance(pos[ioni], pos[ionj], nil_array)
 *             dists[ionj][ioni] = dists[ioni][ionj]
 *     return dists             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __PYX_INC_MEMVIEW(&__pyx_v_dists, 0);
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("relax.potentials.operations.get_all_distances", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
...
/* Python wrapper */
static PyObject *__pyx_pw_5relax_10potentials_10operations_1get_all_distances(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_5relax_10potentials_10operations_1get_all_distances(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_all_distances (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_pos,&__pyx_n_s_N,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_N)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("get_all_distances", 1, 2, 2, 1); __PYX_ERR(0, 162, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_all_distances") < 0)) __PYX_ERR(0, 162, __pyx_L3_error)
      }
    ...
    __pyx_v_pos = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_pos.memview)) __PYX_ERR(0, 162, __pyx_L3_error)
    __pyx_v_N = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_N == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 162, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_all_distances", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 162, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("relax.potentials.operations.get_all_distances", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5relax_10potentials_10operations_get_all_distances(__pyx_self, __pyx_v_pos, __pyx_v_N);
...
static PyObject *__pyx_pf_5relax_10potentials_10operations_get_all_distances(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_pos, int __pyx_v_N) {
  ...
  if (unlikely(!__pyx_v_pos.memview)) { __Pyx_RaiseUnboundLocalError("pos"); __PYX_ERR(0, 162, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_5relax_10potentials_10operations_get_all_distances(__pyx_v_pos, __pyx_v_N, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 162, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 162, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
...
/* "relax/potentials/operations.pyx":177
 * 
 * 
...
static PyObject *__pyx_pw_5relax_10potentials_10operations_3get_min_dist(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_5relax_10potentials_10operations_get_min_dist(__Pyx_memviewslice __pyx_v_pos, int __pyx_v_N, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_ioni;
  Py_ssize_t __pyx_v_ionj;
  double __pyx_v_dist;
  __Pyx_memviewslice __pyx_v_nil_array = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("get_min_dist", 0);

  /* "relax/potentials/operations.pyx":181
 *     cdef Py_ssize_t ioni, ionj
 *     cdef double dist
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_3 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_3.memview)) __PYX_ERR(0, 181, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_nil_array = __pyx_t_3;
  __pyx_t_3.memview = NULL;
  __pyx_t_3.data = NULL;

  /* "relax/potentials/operations.pyx":182
 *     cdef double dist
 *     cdef double[:] nil_array = array("d",[0,0,0])
 *     cdef double[:] mins = array("d",[0,0,0])             # <<<<<<<<<<<<<<
 * 
 *     for ioni in range(N):
 */
  __pyx_t_1 = PyList_New(3); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 182, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_INCREF(__pyx_int_0);
  __Pyx_GIVEREF(__pyx_int_0);
  PyList_SET_ITEM(__pyx_t_1, 0, __pyx_int_0);
  ...
  PyTuple_SET_ITEM(__pyx_t_2, 1, __pyx_t_1);
  __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_7cpython_5array_array), __pyx_t_2, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 182, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_3 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_3.memview)) __PYX_ERR(0, 182, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_mins = __pyx_t_3;
  __pyx_t_3.memview = NULL;
  __pyx_t_3.data = NULL;

  /* "relax/potentials/operations.pyx":184
 *     cdef double[:] mins = array("d",[0,0,0])
 * 
 *     for ioni in range(N):             # <<<<<<<<<<<<<<
 *         for ionj in range(ioni, N):
 ...
 */
  ...
  __pyx_t_5 = __pyx_t_4;
  for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
    __pyx_v_ioni = __pyx_t_6;

    /* "relax/potentials/operations.pyx":185
 * 
 *     for ioni in range(N):
 *         for ionj in range(ioni, N):             # <<<<<<<<<<<<<<
 *             dist = get_real_distance(pos[ioni], pos[ionj], nil_array)
 ...
 */
    __pyx_t_7 = __pyx_v_N;
    __pyx_t_8 = __pyx_t_7;
    for (__pyx_t_9 = __pyx_v_ioni; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
      __pyx_v_ionj = __pyx_t_9;

      /* "relax/potentials/operations.pyx":186
 *     for ioni in range(N):
 *         for ionj in range(ioni, N):
 *             dist = get_real_distance(pos[ioni], pos[ionj], nil_array)             # <<<<<<<<<<<<<<
 *             if (ioni==1) & (ionj==2):
...
__pyx_t_10.shape[0] = __pyx_v_pos.shape[1];
__pyx_t_10.strides[0] = __pyx_v_pos.strides[1];
    __pyx_t_10.suboffsets[0] = -1;

__pyx_v_dist = __pyx_f_5relax_10potentials_10operations_get_real_distance(__pyx_t_3, __pyx_t_10, __pyx_v_nil_array);
      __PYX_XDEC_MEMVIEW(&__pyx_t_3, 1);
      __pyx_t_3.memview = NULL;
      __pyx_t_3.data = NULL;
      ...
      /* "relax/potentials/operations.pyx":187
 *         for ionj in range(ioni, N):
 *             dist = get_real_distance(pos[ioni], pos[ionj], nil_array)
 *             if (ioni==1) & (ionj==2):             # <<<<<<<<<<<<<<
 *                 mins[0] = dist
 *                 mins[1] = ioni
 */
      __pyx_t_11 = (((__pyx_v_ioni == 1) & (__pyx_v_ionj == 2)) != 0);
      if (__pyx_t_11) {

        /* "relax/potentials/operations.pyx":188
 *             dist = get_real_distance(pos[ioni], pos[ionj], nil_array)
 *             if (ioni==1) & (ionj==2):
 *                 mins[0] = dist             # <<<<<<<<<<<<<<
 *                 mins[1] = ioni
 ...
 */
        ...
        __pyx_t_13 = -1;
        if (__pyx_t_12 < 0) {
          __pyx_t_12 += __pyx_v_mins.shape[0];
          if (unlikely(__pyx_t_12 < 0)) __pyx_t_13 = 0;
        } else if (unlikely(__pyx_t_12 >= __pyx_v_mins.shape[0])) __pyx_t_13 = 0;
        if (unlikely(__pyx_t_13 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_13);
          __PYX_ERR(0, 188, __pyx_L1_error)
        }
        *((double *) ( /* dim=0 */ (__pyx_v_mins.data + __pyx_t_12 * __pyx_v_mins.strides[0]) )) = __pyx_v_dist;

        /* "relax/potentials/operations.pyx":189
 *             if (ioni==1) & (ionj==2):
 *                 mins[0] = dist
 *                 mins[1] = ioni             # <<<<<<<<<<<<<<
 *                 mins[2] = ionj
 ...
 */
        ...
        *((double *) ( /* dim=0 */ (__pyx_v_mins.data + __pyx_t_12 * __pyx_v_mins.strides[0]) )) = __pyx_v_ioni;

        /* "relax/potentials/operations.pyx":190
 *                 mins[0] = dist
 *                 mins[1] = ioni
 *                 mins[2] = ionj             # <<<<<<<<<<<<<<
 *             elif (dist>0) & (dist<mins[0]):
 ...
 */
        ...
        *((double *) ( /* dim=0 */ (__pyx_v_mins.data + __pyx_t_12 * __pyx_v_mins.strides[0]) )) = __pyx_v_ionj;
 ...
 */
      ...
      /* "relax/potentials/operations.pyx":191
 *                 mins[1] = ioni
 *                 mins[2] = ionj
 *             elif (dist>0) & (dist<mins[0]):             # <<<<<<<<<<<<<<
 *                 mins[0] = dist
 ...
 */
      ...
      __pyx_t_11 = (((__pyx_v_dist > 0.0) & (__pyx_v_dist < (*((double *) ( /* dim=0 */ (__pyx_v_mins.data + __pyx_t_12 * __pyx_v_mins.strides[0]) ))))) != 0);
      if (__pyx_t_11) {

        /* "relax/potentials/operations.pyx":192
 *                 mins[2] = ionj
 *             elif (dist>0) & (dist<mins[0]):
 *                 mins[0] = dist             # <<<<<<<<<<<<<<
 *                 mins[1] = ioni
 ...
 */
        ...
        *((double *) ( /* dim=0 */ (__pyx_v_mins.data + __pyx_t_12 * __pyx_v_mins.strides[0]) )) = __pyx_v_dist;
        ...
        /* "relax/potentials/operations.pyx":193
 *             elif (dist>0) & (dist<mins[0]):
 *                 mins[0] = dist
 *                 mins[1] = ioni             # <<<<<<<<<<<<<<
 *                 mins[2] = ionj
 ...
 */
        ...
        *((double *) ( /* dim=0 */ (__pyx_v_mins.data + __pyx_t_12 * __pyx_v_mins.strides[0]) )) = __pyx_v_ioni;
        ...
        /* "relax/potentials/operations.pyx":194
 *                 mins[0] = dist
 *                 mins[1] = ioni
 *                 mins[2] = ionj             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "relax/potentials/operations.pyx":196
 *                 mins[2] = ionj
 * 
 *     return mins             # <<<<<<<<<<<<<<
 */
  __PYX_INC_MEMVIEW(&__pyx_v_mins, 0);
  __pyx_r = __pyx_v_mins;
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("relax.potentials.operations.get_min_dist", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
...
/* Python wrapper */
static PyObject *__pyx_pw_5relax_10potentials_10operations_3get_min_dist(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_5relax_10potentials_10operations_3get_min_dist(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_pos = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_N;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_min_dist (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_pos,&__pyx_n_s_N,0};
    PyObject* values[2] = {0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_N)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("get_min_dist", 1, 2, 2, 1); __PYX_ERR(0, 177, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_min_dist") < 0)) __PYX_ERR(0, 177, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_pos = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_pos.memview)) __PYX_ERR(0, 177, __pyx_L3_error)
    __pyx_v_N = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_N == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 177, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_min_dist", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 177, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("relax.potentials.operations.get_min_dist", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5relax_10potentials_10operations_2get_min_dist(__pyx_self, __pyx_v_pos, __pyx_v_N);
...
static PyObject *__pyx_pf_5relax_10potentials_10operations_2get_min_dist(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_pos, int __pyx_v_N) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_memviewslice __pyx_t_1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_t_2 = NULL;
  ...
  __Pyx_RefNannySetupContext("get_min_dist", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_pos.memview)) { __Pyx_RaiseUnboundLocalError("pos"); __PYX_ERR(0, 177, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_5relax_10potentials_10operations_get_min_dist(__pyx_v_pos, __pyx_v_N, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 177, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 177, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __PYX_XDEC_MEMVIEW(&__pyx_t_1, 1);
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "relax.potentials.operations.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "relax.potentials.operations.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "relax.potentials.operations.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "relax.potentials.operations._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"get_all_distances", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5relax_10potentials_10operations_1get_all_distances, METH_VARARGS|METH_KEYWORDS, 0},
  {"get_min_dist", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5relax_10potentials_10operations_3get_min_dist, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_u_Error_in_matrices_dimensions, __pyx_k_Error_in_matrices_dimensions, sizeof(__pyx_k_Error_in_matrices_dimensions), 0, 1, 0, 0},
  {&__pyx_kp_u_Error_in_matrix_s_dimensions, __pyx_k_Error_in_matrix_s_dimensions, sizeof(__pyx_k_Error_in_matrix_s_dimensions), 0, 1, 0, 0},
  {&__pyx_kp_u_Error_in_vectors_dimensions, __pyx_k_Error_in_vectors_dimensions, sizeof(__pyx_k_Error_in_vectors_dimensions), 0, 1, 0, 0},
 ...
 *     cdef double result = 0
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_u_Error_in_vectors_dimensions); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 18, __pyx_L1_error)
 ...
 *     cdef double[:,:] result
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_u_Error_in_matrices_dimensions); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 68, __pyx_L1_error)
 ...
 *     cdef double det
 */
  __pyx_tuple__3 = PyTuple_Pack(1, __pyx_kp_u_Error_in_matrix_s_dimensions); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 123, __pyx_L1_error)
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("dot_vv", (void (*)(void))__pyx_f_5relax_10potentials_10operations_dot_vv, "double (__Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("dot_vm", (void (*)(void))__pyx_f_5relax_10potentials_10operations_dot_vm, "__Pyx_memviewslice (__Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("dot_mm", (void (*)(void))__pyx_f_5relax_10potentials_10operations_dot_mm, "__Pyx_memviewslice (__Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("norm", (void (*)(void))__pyx_f_5relax_10potentials_10operations_norm, "double (__Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("norm_m", (void (*)(void))__pyx_f_5relax_10potentials_10operations_norm_m, "double (__Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("det", (void (*)(void))__pyx_f_5relax_10potentials_10operations_det, "double (__Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("get_real_distance", (void (*)(void))__pyx_f_5relax_10potentials_10operations_get_real_distance, "double (__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("get_recip_distance", (void (*)(void))__pyx_f_5relax_10potentials_10operations_get_recip_distance, "double (double *, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("get_distance_vector", (void (*)(void))__pyx_f_5relax_10potentials_10operations_get_distance_vector, "double *(double *, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("get_all_distances", (void (*)(void))__pyx_f_5relax_10potentials_10operations_get_all_distances, "__Pyx_memviewslice (__Pyx_memviewslice, int, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("get_min_dist", (void (*)(void))__pyx_f_5relax_10potentials_10operations_get_min_dist, "__Pyx_memviewslice (__Pyx_memviewslice, int, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("operations", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_relax__potentials__operations) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "relax.potentials.operations")) {
      if (unlikely(PyDict_SetItemString(modules, "relax.potentials.operations", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "relax/potentials/operations.pyx":1
 * import cython             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init relax.potentials.operations", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init relax.potentials.operations");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
